...
public final class ManagementPlugin_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final ManagementPlugin managementPlugin = (ManagementPlugin)remote;
        throw new UnmarshalException("invalid method number");
    }
    
    public Operation[] getOperations() {
        return ManagementPlugin_Skel.operations.clone();
    }
}

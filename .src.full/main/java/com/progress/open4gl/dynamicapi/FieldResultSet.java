...
public class FieldResultSet implements ResultSet
{
    private ResultSetMetaData metaData;
    private int numflds;
    private int current;
    
    FieldResultSet(final ResultSetMetaData metaData) {
        this.metaData = metaData;
        this.current = 0;
        this.numflds = this.metaData.getFieldCount();
    }
    
    public boolean next() throws Open4GLError {
        return this.current++ < this.numflds;
    }
    ...
    public Object getObject(final int n) throws Open4GLError {
        try {
            switch (n) {
                case 1: {
                    return new Integer(this.metaData.getFieldProType(this.current));
                }
                case 2: {
                    return new Integer(this.metaData.getFieldExtent(this.current));
                }
                case 3: {
                    return this.metaData.getFieldName(this.current);
                }
                case 4: {
                    return new Integer(this.current + 1);
                }
                case 5: {
                    return new Integer(this.current - 1);
                }
                case 6: {
                    return new Integer(this.metaData.getFlag(this.current));
                }
                case 7: {
                    return null;
                }
    ...
    public java.sql.ResultSetMetaData getMetaData() throws Open4GLError {
        throw new Open4GLError();
    }

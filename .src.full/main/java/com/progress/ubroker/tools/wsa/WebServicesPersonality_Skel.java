...
public final class WebServicesPersonality_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final WebServicesPersonality webServicesPersonality = (WebServicesPersonality)remote;
        switch (n) {
            case 0: {
                remoteCall.releaseInputStream();
                final Enumeration children = webServicesPersonality.getChildren();
                try {
            ...
            case 1: {
                remoteCall.releaseInputStream();
                final String displayName = webServicesPersonality.getDisplayName();
                try {
            ...
            case 2: {
                remoteCall.releaseInputStream();
                final String mmcClientClass = webServicesPersonality.getMMCClientClass();
                try {
    ...
    public Operation[] getOperations() {
        return WebServicesPersonality_Skel.operations.clone();
    }
}

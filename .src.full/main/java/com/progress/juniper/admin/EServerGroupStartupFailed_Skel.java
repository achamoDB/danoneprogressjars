...
public final class EServerGroupStartupFailed_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EServerGroupStartupFailed eServerGroupStartupFailed = (EServerGroupStartupFailed)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eServerGroupStartupFailed.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eServerGroupStartupFailed.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eServerGroupStartupFailed.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eServerGroupStartupFailed.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eServerGroupStartupFailed.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eServerGroupStartupFailed.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eServerGroupStartupFailed.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eServerGroupStartupFailed.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eServerGroupStartupFailed.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = eServerGroupStartupFailed.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eServerGroupStartupFailed.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = eServerGroupStartupFailed.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eServerGroupStartupFailed.getSubCategory();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eServerGroupStartupFailed.issuer();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eServerGroupStartupFailed.issuerName();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final IJAService serverGroup = eServerGroupStartupFailed.serverGroup();
                    try {
                    ...
                    eServerGroupStartupFailed.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eServerGroupStartupFailed.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String reasonForFailure = eServerGroupStartupFailed.reasonForFailure();
                    try {
    ...
    public Operation[] getOperations() {
        return EServerGroupStartupFailed_Skel.operations.clone();
    }
}

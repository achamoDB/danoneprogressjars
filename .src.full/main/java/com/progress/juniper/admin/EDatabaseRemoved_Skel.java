...
public final class EDatabaseRemoved_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EDatabaseRemoved eDatabaseRemoved = (EDatabaseRemoved)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eDatabaseRemoved.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJADatabase database = eDatabaseRemoved.database();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eDatabaseRemoved.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eDatabaseRemoved.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eDatabaseRemoved.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eDatabaseRemoved.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eDatabaseRemoved.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eDatabaseRemoved.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eDatabaseRemoved.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eDatabaseRemoved.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eDatabaseRemoved.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eDatabaseRemoved.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eDatabaseRemoved.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eDatabaseRemoved.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eDatabaseRemoved.issuerName();
                    try {
                    ...
                    eDatabaseRemoved.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eDatabaseRemoved.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eDatabaseRemoved.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EDatabaseRemoved_Skel.operations.clone();
    }
}

...
public final class EARCrash_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 488897109503288161L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EARCrash earCrash = (EARCrash)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final IJAAgent agent = earCrash.agent();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final Class classDef = earCrash.classDef();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = earCrash.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = earCrash.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = earCrash.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = earCrash.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = earCrash.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = earCrash.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = earCrash.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = earCrash.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = earCrash.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = earCrash.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = earCrash.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = earCrash.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = earCrash.issuer();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String reasonForFailure = earCrash.reasonForFailure();
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = earCrash.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = earCrash.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EARCrash_Skel.operations.clone();
    }
}

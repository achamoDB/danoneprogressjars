...
public final class EAutostartCompleted_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EAutostartCompleted eAutostartCompleted = (EAutostartCompleted)remote;
        Label_0828: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eAutostartCompleted.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eAutostartCompleted.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eAutostartCompleted.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eAutostartCompleted.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eAutostartCompleted.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eAutostartCompleted.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eAutostartCompleted.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eAutostartCompleted.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eAutostartCompleted.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = eAutostartCompleted.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eAutostartCompleted.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = eAutostartCompleted.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eAutostartCompleted.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eAutostartCompleted.issuerName();
                    try {
                    ...
                    eAutostartCompleted.setSource(source2);
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eAutostartCompleted.timeIssued();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eAutostartCompleted.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EAutostartCompleted_Skel.operations.clone();
    }
}

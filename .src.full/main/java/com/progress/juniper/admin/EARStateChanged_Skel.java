...
public final class EARStateChanged_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -4349887494098084478L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EARStateChanged earStateChanged = (EARStateChanged)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final IJAAgent agent = earStateChanged.agent();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final Class classDef = earStateChanged.classDef();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = earStateChanged.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = earStateChanged.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = earStateChanged.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = earStateChanged.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = earStateChanged.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = earStateChanged.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = earStateChanged.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = earStateChanged.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = earStateChanged.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = earStateChanged.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = earStateChanged.getSource();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = earStateChanged.getSubCategory();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String issuerName = earStateChanged.issuerName();
                    try {
                    ...
                    earStateChanged.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = earStateChanged.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object issuer = earStateChanged.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EARStateChanged_Skel.operations.clone();
    }
}

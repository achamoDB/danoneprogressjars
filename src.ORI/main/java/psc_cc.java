...
public class psc_cc extends psc_aj implements Cloneable, Serializable, psc_bj
{
    private String a;
    psc_n b;
    ...
    public psc_cc() {
        ...
        super.bt = false;
        this.a(psc_aj.af);
        super.a = "NetscapeBaseURL";
    }
    
    public psc_cc(final String a, final boolean bt) {
        super.bu = 102;
        super.bt = bt;
        this.a(psc_aj.af);
        if (a != null) {
    ...
    public void d(final byte[] array, final int n) throws psc_g {
        ...
        try {
            ...
            throw new psc_g("Could not decode NetscapeBaseURL extension.");
        }
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        final psc_cc psc_cc = new psc_cc();
        psc_cc.a = this.a;
        if (this.b != null) {
            psc_cc.e();
        }

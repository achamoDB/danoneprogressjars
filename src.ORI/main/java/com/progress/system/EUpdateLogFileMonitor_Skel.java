...
public final class EUpdateLogFileMonitor_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EUpdateLogFileMonitor eUpdateLogFileMonitor = (EUpdateLogFileMonitor)remote;
        Label_0776: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eUpdateLogFileMonitor.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eUpdateLogFileMonitor.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eUpdateLogFileMonitor.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eUpdateLogFileMonitor.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eUpdateLogFileMonitor.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eUpdateLogFileMonitor.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eUpdateLogFileMonitor.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eUpdateLogFileMonitor.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eUpdateLogFileMonitor.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eUpdateLogFileMonitor.getSeverityLevel();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final String source = eUpdateLogFileMonitor.getSource();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eUpdateLogFileMonitor.getSubCategory();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eUpdateLogFileMonitor.issuerName();
                    try {
                    ...
                    eUpdateLogFileMonitor.setSource(source2);
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eUpdateLogFileMonitor.timeIssued();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eUpdateLogFileMonitor.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EUpdateLogFileMonitor_Skel.operations.clone();
    }
}

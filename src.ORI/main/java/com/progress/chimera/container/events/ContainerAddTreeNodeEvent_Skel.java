...
public final class ContainerAddTreeNodeEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -6369654689115327360L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final ContainerAddTreeNodeEvent containerAddTreeNodeEvent = (ContainerAddTreeNodeEvent)remote;
        Label_0984: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = containerAddTreeNodeEvent.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = containerAddTreeNodeEvent.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = containerAddTreeNodeEvent.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = containerAddTreeNodeEvent.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = containerAddTreeNodeEvent.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final Object child = containerAddTreeNodeEvent.getChild();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = containerAddTreeNodeEvent.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = containerAddTreeNodeEvent.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final IChimeraHierarchy nodeObj = containerAddTreeNodeEvent.getNodeObj();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationName = containerAddTreeNodeEvent.getNotificationName();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final String notificationType = containerAddTreeNodeEvent.getNotificationType();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final IChimeraHierarchy parentNode = containerAddTreeNodeEvent.getParentNode();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = containerAddTreeNodeEvent.getSeverityLevel();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String source = containerAddTreeNodeEvent.getSource();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = containerAddTreeNodeEvent.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object guiID = containerAddTreeNodeEvent.guiID();
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final String issuerName = containerAddTreeNodeEvent.issuerName();
                    try {
                    ...
                    containerAddTreeNodeEvent.setSource(source2);
                    try {
                ...
                case 19: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = containerAddTreeNodeEvent.timeIssued();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Object issuer = containerAddTreeNodeEvent.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return ContainerAddTreeNodeEvent_Skel.operations.clone();
    }
}

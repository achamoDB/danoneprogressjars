...
public final class EConfigPropertyChangedEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EConfigPropertyChangedEvent eConfigPropertyChangedEvent = (EConfigPropertyChangedEvent)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eConfigPropertyChangedEvent.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJAConfiguration configuration = eConfigPropertyChangedEvent.configuration();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eConfigPropertyChangedEvent.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eConfigPropertyChangedEvent.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eConfigPropertyChangedEvent.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eConfigPropertyChangedEvent.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eConfigPropertyChangedEvent.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eConfigPropertyChangedEvent.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eConfigPropertyChangedEvent.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eConfigPropertyChangedEvent.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eConfigPropertyChangedEvent.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eConfigPropertyChangedEvent.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eConfigPropertyChangedEvent.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eConfigPropertyChangedEvent.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object guiID = eConfigPropertyChangedEvent.guiID();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eConfigPropertyChangedEvent.issuerName();
                    try {
                    ...
                    eConfigPropertyChangedEvent.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eConfigPropertyChangedEvent.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eConfigPropertyChangedEvent.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EConfigPropertyChangedEvent_Skel.operations.clone();
    }
}

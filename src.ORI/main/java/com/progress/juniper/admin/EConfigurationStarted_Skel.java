...
public final class EConfigurationStarted_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 4032890211476974108L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EConfigurationStarted eConfigurationStarted = (EConfigurationStarted)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eConfigurationStarted.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String configurationName = eConfigurationStarted.configurationName();
                    try {
                        remoteCall.getResultStream(true).writeObject(configurationName);
                        return;
                    }
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eConfigurationStarted.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eConfigurationStarted.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eConfigurationStarted.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eConfigurationStarted.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eConfigurationStarted.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eConfigurationStarted.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eConfigurationStarted.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eConfigurationStarted.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eConfigurationStarted.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eConfigurationStarted.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eConfigurationStarted.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eConfigurationStarted.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eConfigurationStarted.issuerName();
                    try {
                    ...
                    eConfigurationStarted.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eConfigurationStarted.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eConfigurationStarted.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EConfigurationStarted_Skel.operations.clone();
    }
}

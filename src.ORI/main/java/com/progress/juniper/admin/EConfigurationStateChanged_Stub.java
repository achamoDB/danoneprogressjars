...
public final class EConfigurationStateChanged_Stub extends RemoteStub implements IEStateChangedEvent, IEConfigurationEvent, IEJAEvent, INotificationEvent, IEventObject, Remote
{
    private static final Operation[] operations;
    private static final long interfaceHash = 8665737162927578112L;
    ...
    public EConfigurationStateChanged_Stub() {
    }
    
    public EConfigurationStateChanged_Stub(final RemoteRef ref) {
        super(ref);
    }
    
    public Class classDef() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 0, 8665737162927578112L);
    ...
    public IJAConfiguration configuration() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 1, 8665737162927578112L);
            super.ref.invoke(call);
    ...
    public String description() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 2, 8665737162927578112L);
            super.ref.invoke(call);
            String s;
            try {
    ...
    public String eventTypeString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 3, 8665737162927578112L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public boolean expedite() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 4, 8665737162927578112L);
            super.ref.invoke(call);
            boolean boolean1;
            try {
    ...
    public short getCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 5, 8665737162927578112L);
            super.ref.invoke(call);
            short short1;
            try {
    ...
    public String getErrorString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 6, 8665737162927578112L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getEventData() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 7, 8665737162927578112L);
            super.ref.invoke(call);
            Object object;
            try {
    ...
    public String getNotificationName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 8, 8665737162927578112L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getNotificationType() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 9, 8665737162927578112L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getObject() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 10, 8665737162927578112L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public int getSeverityLevel() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 11, 8665737162927578112L);
            super.ref.invoke(call);
            int int1;
            try {
    ...
    public String getSource() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 12, 8665737162927578112L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public JAStatusObject getStatus() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 13, 8665737162927578112L);
            super.ref.invoke(call);
    ...
    public String getSubCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 14, 8665737162927578112L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object issuer() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 15, 8665737162927578112L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public String issuerName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 16, 8665737162927578112L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public void setSource(final String s) throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 17, 8665737162927578112L);
            try {
    ...
    public Date timeIssued() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationStateChanged_Stub.operations, 18, 8665737162927578112L);
            super.ref.invoke(call);
            Date date;
            try {

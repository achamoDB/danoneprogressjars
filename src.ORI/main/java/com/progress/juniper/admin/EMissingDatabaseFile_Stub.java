...
public final class EMissingDatabaseFile_Stub extends RemoteStub implements IEStartupComplete, IEFailure, IEDatabaseEvent, IEJAEvent, INotificationEvent, IEventObject, Remote
{
    ...
    public EMissingDatabaseFile_Stub() {
    }
    
    public EMissingDatabaseFile_Stub(final RemoteRef ref) {
        super(ref);
    }
    
    public Class classDef() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 0, -8019233923684216912L);
    ...
    public IJADatabase database() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 1, -8019233923684216912L);
            super.ref.invoke(call);
    ...
    public String description() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 2, -8019233923684216912L);
            super.ref.invoke(call);
            String s;
            try {
    ...
    public String eventTypeString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 3, -8019233923684216912L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public boolean expedite() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 4, -8019233923684216912L);
            super.ref.invoke(call);
            boolean boolean1;
            try {
    ...
    public short getCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 5, -8019233923684216912L);
            super.ref.invoke(call);
            short short1;
            try {
    ...
    public String getErrorString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 6, -8019233923684216912L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getEventData() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 7, -8019233923684216912L);
            super.ref.invoke(call);
            Object object;
            try {
    ...
    public String getNotificationName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 8, -8019233923684216912L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getNotificationType() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 9, -8019233923684216912L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getObject() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 10, -8019233923684216912L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public int getSeverityLevel() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 11, -8019233923684216912L);
            super.ref.invoke(call);
            int int1;
            try {
    ...
    public String getSource() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 12, -8019233923684216912L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getSubCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 13, -8019233923684216912L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object issuer() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 14, -8019233923684216912L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public String issuerName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 15, -8019233923684216912L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String reasonForFailure() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 16, -8019233923684216912L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public void setSource(final String s) throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 17, -8019233923684216912L);
            try {
    ...
    public Date timeIssued() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EMissingDatabaseFile_Stub.operations, 18, -8019233923684216912L);
            super.ref.invoke(call);
            Date date;
            try {

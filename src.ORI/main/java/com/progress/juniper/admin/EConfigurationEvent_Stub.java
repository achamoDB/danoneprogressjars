...
public final class EConfigurationEvent_Stub extends RemoteStub implements IEConfigurationEvent, IEJAEvent, INotificationEvent, IEventObject, Remote
{
    ...
    public EConfigurationEvent_Stub() {
    }
    
    public EConfigurationEvent_Stub(final RemoteRef ref) {
        super(ref);
    }
    
    public Class classDef() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 0, -3092750500477704221L);
    ...
    public IJAConfiguration configuration() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 1, -3092750500477704221L);
            super.ref.invoke(call);
    ...
    public String description() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 2, -3092750500477704221L);
            super.ref.invoke(call);
            String s;
            try {
    ...
    public String eventTypeString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 3, -3092750500477704221L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public boolean expedite() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 4, -3092750500477704221L);
            super.ref.invoke(call);
            boolean boolean1;
            try {
    ...
    public short getCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 5, -3092750500477704221L);
            super.ref.invoke(call);
            short short1;
            try {
    ...
    public String getErrorString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 6, -3092750500477704221L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getEventData() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 7, -3092750500477704221L);
            super.ref.invoke(call);
            Object object;
            try {
    ...
    public String getNotificationName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 8, -3092750500477704221L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getNotificationType() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 9, -3092750500477704221L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getObject() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 10, -3092750500477704221L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public int getSeverityLevel() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 11, -3092750500477704221L);
            super.ref.invoke(call);
            int int1;
            try {
    ...
    public String getSource() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 12, -3092750500477704221L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getSubCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 13, -3092750500477704221L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object issuer() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 14, -3092750500477704221L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public String issuerName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 15, -3092750500477704221L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public void setSource(final String s) throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 16, -3092750500477704221L);
            try {
    ...
    public Date timeIssued() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EConfigurationEvent_Stub.operations, 17, -3092750500477704221L);
            super.ref.invoke(call);
            Date date;
            try {

...
public final class RegistrationEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 8296696076407409469L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final RegistrationEvent registrationEvent = (RegistrationEvent)remote;
        switch (n) {
            case 0: {
                remoteCall.releaseInputStream();
                final Class classDef = registrationEvent.classDef();
                try {
            ...
            case 2: {
                remoteCall.releaseInputStream();
                final String description = registrationEvent.description();
                try {
            ...
            case 3: {
                remoteCall.releaseInputStream();
                final String eventTypeString = registrationEvent.eventTypeString();
                try {
            ...
            case 4: {
                remoteCall.releaseInputStream();
                final boolean expedite = registrationEvent.expedite();
                try {
            ...
            case 5: {
                remoteCall.releaseInputStream();
                final Object issuer = registrationEvent.issuer();
                try {
            ...
            case 6: {
                remoteCall.releaseInputStream();
                final String issuerName = registrationEvent.issuerName();
                try {
            ...
            case 7: {
                remoteCall.releaseInputStream();
                final Date timeIssued = registrationEvent.timeIssued();
                try {
    ...
    public Operation[] getOperations() {
        return RegistrationEvent_Skel.operations.clone();
    }
}

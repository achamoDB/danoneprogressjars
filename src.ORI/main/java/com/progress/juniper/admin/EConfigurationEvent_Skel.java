...
public final class EConfigurationEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EConfigurationEvent eConfigurationEvent = (EConfigurationEvent)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eConfigurationEvent.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJAConfiguration configuration = eConfigurationEvent.configuration();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eConfigurationEvent.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eConfigurationEvent.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eConfigurationEvent.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eConfigurationEvent.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eConfigurationEvent.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eConfigurationEvent.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eConfigurationEvent.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eConfigurationEvent.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eConfigurationEvent.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eConfigurationEvent.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eConfigurationEvent.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eConfigurationEvent.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eConfigurationEvent.issuerName();
                    try {
                    ...
                    eConfigurationEvent.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eConfigurationEvent.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eConfigurationEvent.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EConfigurationEvent_Skel.operations.clone();
    }
}

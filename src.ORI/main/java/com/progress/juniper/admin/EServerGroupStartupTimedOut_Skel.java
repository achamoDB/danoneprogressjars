...
public final class EServerGroupStartupTimedOut_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 9217273747890197758L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EServerGroupStartupTimedOut eServerGroupStartupTimedOut = (EServerGroupStartupTimedOut)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eServerGroupStartupTimedOut.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eServerGroupStartupTimedOut.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eServerGroupStartupTimedOut.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eServerGroupStartupTimedOut.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eServerGroupStartupTimedOut.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eServerGroupStartupTimedOut.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eServerGroupStartupTimedOut.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eServerGroupStartupTimedOut.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eServerGroupStartupTimedOut.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = eServerGroupStartupTimedOut.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eServerGroupStartupTimedOut.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = eServerGroupStartupTimedOut.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eServerGroupStartupTimedOut.getSubCategory();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eServerGroupStartupTimedOut.issuer();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eServerGroupStartupTimedOut.issuerName();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final IJAService serverGroup = eServerGroupStartupTimedOut.serverGroup();
                    try {
                    ...
                    eServerGroupStartupTimedOut.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eServerGroupStartupTimedOut.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String reasonForFailure = eServerGroupStartupTimedOut.reasonForFailure();
                    try {
    ...
    public Operation[] getOperations() {
        return EServerGroupStartupTimedOut_Skel.operations.clone();
    }
}

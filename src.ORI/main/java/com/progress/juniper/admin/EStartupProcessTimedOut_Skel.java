...
public final class EStartupProcessTimedOut_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -8019233923684216912L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EStartupProcessTimedOut eStartupProcessTimedOut = (EStartupProcessTimedOut)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eStartupProcessTimedOut.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJADatabase database = eStartupProcessTimedOut.database();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eStartupProcessTimedOut.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eStartupProcessTimedOut.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eStartupProcessTimedOut.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eStartupProcessTimedOut.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eStartupProcessTimedOut.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eStartupProcessTimedOut.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eStartupProcessTimedOut.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eStartupProcessTimedOut.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eStartupProcessTimedOut.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eStartupProcessTimedOut.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eStartupProcessTimedOut.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eStartupProcessTimedOut.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eStartupProcessTimedOut.issuer();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String reasonForFailure = eStartupProcessTimedOut.reasonForFailure();
                    try {
                    ...
                    eStartupProcessTimedOut.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eStartupProcessTimedOut.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eStartupProcessTimedOut.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EStartupProcessTimedOut_Skel.operations.clone();
    }
}

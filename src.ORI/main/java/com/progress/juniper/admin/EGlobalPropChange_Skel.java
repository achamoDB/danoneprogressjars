...
public final class EGlobalPropChange_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 4992652629135249948L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EGlobalPropChange eGlobalPropChange = (EGlobalPropChange)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eGlobalPropChange.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eGlobalPropChange.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eGlobalPropChange.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eGlobalPropChange.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eGlobalPropChange.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eGlobalPropChange.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eGlobalPropChange.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eGlobalPropChange.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eGlobalPropChange.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = eGlobalPropChange.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eGlobalPropChange.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = eGlobalPropChange.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final JAStatusObject status = eGlobalPropChange.getStatus();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eGlobalPropChange.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eGlobalPropChange.issuerName();
                    try {
                    ...
                    eGlobalPropChange.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eGlobalPropChange.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eGlobalPropChange.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EGlobalPropChange_Skel.operations.clone();
    }
}

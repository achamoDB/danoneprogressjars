...
public final class EDatabaseAdded_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -1084760970313970033L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EDatabaseAdded eDatabaseAdded = (EDatabaseAdded)remote;
        Label_0984: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eDatabaseAdded.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJADatabase database = eDatabaseAdded.database();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eDatabaseAdded.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eDatabaseAdded.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eDatabaseAdded.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eDatabaseAdded.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object child = eDatabaseAdded.getChild();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String errorString = eDatabaseAdded.getErrorString();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eDatabaseAdded.getEventData();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eDatabaseAdded.getNotificationName();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eDatabaseAdded.getNotificationType();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final Object object = eDatabaseAdded.getObject();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eDatabaseAdded.getSeverityLevel();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String source = eDatabaseAdded.getSource();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eDatabaseAdded.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object guiID = eDatabaseAdded.guiID();
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eDatabaseAdded.issuerName();
                    try {
                    ...
                    eDatabaseAdded.setSource(source2);
                    try {
                ...
                case 19: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eDatabaseAdded.timeIssued();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eDatabaseAdded.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EDatabaseAdded_Skel.operations.clone();
    }
}

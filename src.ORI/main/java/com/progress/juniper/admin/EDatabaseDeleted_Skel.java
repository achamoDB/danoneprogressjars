...
public final class EDatabaseDeleted_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EDatabaseDeleted eDatabaseDeleted = (EDatabaseDeleted)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eDatabaseDeleted.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJADatabase database = eDatabaseDeleted.database();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eDatabaseDeleted.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eDatabaseDeleted.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eDatabaseDeleted.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eDatabaseDeleted.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eDatabaseDeleted.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eDatabaseDeleted.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eDatabaseDeleted.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eDatabaseDeleted.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eDatabaseDeleted.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eDatabaseDeleted.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eDatabaseDeleted.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eDatabaseDeleted.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object guiID = eDatabaseDeleted.guiID();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eDatabaseDeleted.issuerName();
                    try {
                    ...
                    eDatabaseDeleted.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eDatabaseDeleted.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eDatabaseDeleted.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EDatabaseDeleted_Skel.operations.clone();
    }
}

...
public final class ESMDCrash_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final ESMDCrash esmdCrash = (ESMDCrash)remote;
        Label_0828: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = esmdCrash.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = esmdCrash.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = esmdCrash.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = esmdCrash.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = esmdCrash.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = esmdCrash.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = esmdCrash.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = esmdCrash.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = esmdCrash.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = esmdCrash.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = esmdCrash.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = esmdCrash.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = esmdCrash.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String issuerName = esmdCrash.issuerName();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = esmdCrash.timeIssued();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object issuer = esmdCrash.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return ESMDCrash_Skel.operations.clone();
    }
}

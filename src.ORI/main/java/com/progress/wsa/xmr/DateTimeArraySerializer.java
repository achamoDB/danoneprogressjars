...
public class DateTimeArraySerializer implements Serializer, Deserializer
{
    public void marshall(final String s, final Class clazz, final Object o, final Object o2, final Writer writer, final NSStack nsStack, final XMLJavaMappingRegistry xmlJavaMappingRegistry, final SOAPContext soapContext) throws IllegalArgumentException, IOException {
        final GregorianCalendar[] calArray = ((DateTimeArrayHolder)o).getCalArray();
        ...
        Object o3 = o2;
        int n = 0;
        final Serializer querySerializer = xmlJavaMappingRegistry.querySerializer(DateTimeHolder.class, s);
        ...
        if (null != calArray) {
            ...
            for (int i = 0; i < calArray.length; ++i) {
                querySerializer.marshall(s, clazz, (Object)new DateTimeHolder(calArray[i]), o3, writer, nsStack, xmlJavaMappingRegistry, soapContext);
            }
        }
        else {
    ...
    public Bean unmarshall(final String s, final QName qName, final Node node, final XMLJavaMappingRegistry xmlJavaMappingRegistry, final SOAPContext soapContext) throws IllegalArgumentException {
        final Vector unMarshall = new ArrayParamSerializer().unMarshall(s, new QName("http://www.w3.org/2001/XMLSchema", "dateTimeS"), xmlJavaMappingRegistry, soapContext, (Element)node, new GregorianCalendar());

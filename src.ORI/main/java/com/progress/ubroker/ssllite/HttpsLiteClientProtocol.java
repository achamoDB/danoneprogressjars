...
public final class HttpsLiteClientProtocol extends HttpClientProtocol
{
    ...
    public void init(final Properties properties, final IAppLogger appLogger, final int n) throws Exception, NetworkProtocolException {
        ...
        try {
            ...
            super.m_loggingObj.logStackTrace("Missing the SSLParamsLite and/or SSLSocketUtilsLite classes", t);
        ...
        try {
            ...
            super.m_loggingObj.logStackTrace("SSLParamsLite init error.", ex);
    ...
    public synchronized void sendUbMessage(final HttpClientMsgOutputStream httpClientMsgOutputStream) throws IOException, NetworkProtocolException {
        ...
        try {
            ...
            final int a = this.a(pscl_ah.b());
            if (-1 != a) {
                final NetworkProtocolException ex3 = new NetworkProtocolException(a, super.m_protocolTypeName, pscl_ah.a(pscl_ah.b()));
                super.m_loggingObj.logStackTrace("", ex3);
                throw ex3;
            }
            if (super.m_loggingObj.ifLogBasic(2L, 1)) {
                super.m_loggingObj.logBasic(1, "SSL reported error: " + pscl_ah.a(pscl_ah.b()));
            }
        }
        catch (pscl_ai pscl_ai) {
            final int b3 = this.b(pscl_ai.b());
            if (-1 != b3) {
                final NetworkProtocolException ex4 = new NetworkProtocolException(b3, super.m_protocolTypeName, pscl_ai.getMessage());
            ...
            if (super.m_loggingObj.ifLogVerbose(1L, 0)) {
                super.m_loggingObj.logVerbose(0, "SSL reported error: " + pscl_ai.getMessage());
            }
        }
    ...
    protected void c() throws IOException, NetworkProtocolException {
        ...
        try {
            ...
            final int a = this.a(pscl_ah.b());
            if (-1 != a) {
                final NetworkProtocolException ex = new NetworkProtocolException(a, super.m_protocolTypeName, pscl_ah.a(pscl_ah.b()));
                super.m_loggingObj.logStackTrace("", ex);
                throw ex;
            }
            if (super.m_loggingObj.ifLogBasic(2L, 1)) {
                super.m_loggingObj.logBasic(1, "SSL server reported error: " + pscl_ah.a(pscl_ah.b()));
            }
        }
        catch (pscl_ai pscl_ai) {
            final int b = this.b(pscl_ai.b());
            if (-1 == b) {
                if (super.m_loggingObj.ifLogVerbose(1L, 0)) {
                    super.m_loggingObj.logVerbose(0, "SSL reported error: " + pscl_ai.getMessage());
                }
                ...
                super.m_loggingObj.logStackTrace("", new NetworkProtocolException(b, super.m_protocolTypeName, pscl_ai.getMessage()));
            }
        }
        ...
        if (!this.d()) {
            ...
            if (null == str || 0 == str.length()) {
                str = super.m_connectURL.getHost();
            }
            Pattern compile;
            try {
            ...
            boolean b2 = false;
            try {
                while (!perl5Matcher.matches(stringTokenizer.nextToken(), compile)) {}
                b2 = true;
            }
            catch (Exception ex9) {}
            if (!b2) {
                final NetworkProtocolException ex7 = new NetworkProtocolException(5L, super.m_protocolTypeName, "The server domain '" + str + "' was not in the server certificate subject field.");

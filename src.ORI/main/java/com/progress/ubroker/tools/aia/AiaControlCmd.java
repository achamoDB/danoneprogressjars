...
public class AiaControlCmd extends SvcControlCmd implements IBTMsgCodes
{
    public AiaControlCmd(final SvcStartArgsPkt svcStartArgsPkt, final String s, final String s2, final String s3) {

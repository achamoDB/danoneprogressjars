...
public final class MSRemoteObject_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final MSRemoteObject msRemoteObject = (MSRemoteObject)remote;
        Label_1114: {
            while (true) {
                switch (n) {
                    case 0: {
                        ...
                        final ToolRemoteCmdStatus doRemoteToolCmd = msRemoteObject.doRemoteToolCmd(toolRemoteCmdDescriptor);
                        try {
                    ...
                    case 1: {
                        remoteCall.releaseInputStream();
                        final String adminServerIPAddr = msRemoteObject.getAdminServerIPAddr();
                        try {
                    ...
                    case 2: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrHost = msRemoteObject.getAdminSrvrHost();
                        try {
                    ...
                    case 3: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrOSName = msRemoteObject.getAdminSrvrOSName();
                        try {
                    ...
                    case 4: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrPort = msRemoteObject.getAdminSrvrPort();
                        try {
                    ...
                    case 5: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrURL = msRemoteObject.getAdminSrvrURL();
                        try {
                    ...
                    case 6: {
                        remoteCall.releaseInputStream();
                        final Enumeration children = msRemoteObject.getChildren();
                        try {
                    ...
                    case 7: {
                        remoteCall.releaseInputStream();
                        final String displayName = msRemoteObject.getDisplayName();
                        try {
                    ...
                    case 8: {
                        remoteCall.releaseInputStream();
                        final IEventBroker eventBroker = msRemoteObject.getEventBroker();
                        try {
                        ...
                        final Hashtable logFiles = msRemoteObject.getLogFiles(s);
                        try {
                    ...
                    case 10: {
                        remoteCall.releaseInputStream();
                        final String[] loginUserInfo = msRemoteObject.getLoginUserInfo();
                        try {
                    ...
                    case 11: {
                        remoteCall.releaseInputStream();
                        final String mmcClientClass = msRemoteObject.getMMCClientClass();
                        try {
                    ...
                    case 12: {
                        remoteCall.releaseInputStream();
                        final String propGroupPath = msRemoteObject.getPropGroupPath();
                        try {
                    ...
                    case 13: {
                        remoteCall.releaseInputStream();
                        final String propertyFilename = msRemoteObject.getPropertyFilename();
                        try {
                    ...
                    case 14: {
                        remoteCall.releaseInputStream();
                        final IPropertyManagerRemote rpm = msRemoteObject.getRPM();
                        try {
                    ...
                    case 15: {
                        remoteCall.releaseInputStream();
                        final RemoteStub remStub = msRemoteObject.getRemStub();
                        try {
                    ...
                    case 16: {
                        remoteCall.releaseInputStream();
                        final IYodaRMI remoteManageObject = msRemoteObject.getRemoteManageObject();
                        try {
                        ...
                        final boolean rscLookedUp = msRemoteObject.getRscLookedUp(s2);
                        try {
                    ...
                    case 19: {
                        remoteCall.releaseInputStream();
                        final String[] schemaPropFnList = msRemoteObject.getSchemaPropFnList();
                        try {
                    ...
                    case 20: {
                        remoteCall.releaseInputStream();
                        final String svcName = msRemoteObject.getSvcName();
                        try {
                        ...
                        msRemoteObject.regRscLookedUp(s3);
                        try {
                    ...
                    case 18: {
                        remoteCall.releaseInputStream();
                        final String schemaFilename = msRemoteObject.getSchemaFilename();
                        try {
    ...
    public Operation[] getOperations() {
        return MSRemoteObject_Skel.operations.clone();
    }
}

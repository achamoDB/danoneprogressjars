...
public final class UBTRemoteObject_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final UBTRemoteObject ubtRemoteObject = (UBTRemoteObject)remote;
        Label_0981: {
            while (true) {
                switch (n) {
                    case 0: {
                        remoteCall.releaseInputStream();
                        final String adminServerIPAddr = ubtRemoteObject.getAdminServerIPAddr();
                        try {
                    ...
                    case 1: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrHost = ubtRemoteObject.getAdminSrvrHost();
                        try {
                    ...
                    case 2: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrOSName = ubtRemoteObject.getAdminSrvrOSName();
                        try {
                    ...
                    case 3: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrPort = ubtRemoteObject.getAdminSrvrPort();
                        try {
                    ...
                    case 4: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrURL = ubtRemoteObject.getAdminSrvrURL();
                        try {
                    ...
                    case 5: {
                        remoteCall.releaseInputStream();
                        final Enumeration children = ubtRemoteObject.getChildren();
                        try {
                    ...
                    case 6: {
                        remoteCall.releaseInputStream();
                        final String displayName = ubtRemoteObject.getDisplayName();
                        try {
                    ...
                    case 7: {
                        remoteCall.releaseInputStream();
                        final IEventBroker eventBroker = ubtRemoteObject.getEventBroker();
                        try {
                        ...
                        final Hashtable logFiles = ubtRemoteObject.getLogFiles(s);
                        try {
                    ...
                    case 9: {
                        remoteCall.releaseInputStream();
                        final String[] loginUserInfo = ubtRemoteObject.getLoginUserInfo();
                        try {
                    ...
                    case 10: {
                        remoteCall.releaseInputStream();
                        final String mmcClientClass = ubtRemoteObject.getMMCClientClass();
                        try {
                    ...
                    case 11: {
                        remoteCall.releaseInputStream();
                        final String propGroupPath = ubtRemoteObject.getPropGroupPath();
                        try {
                    ...
                    case 12: {
                        remoteCall.releaseInputStream();
                        final String propertyFilename = ubtRemoteObject.getPropertyFilename();
                        try {
                    ...
                    case 13: {
                        remoteCall.releaseInputStream();
                        final IPropertyManagerRemote rpm = ubtRemoteObject.getRPM();
                        try {
                    ...
                    case 14: {
                        remoteCall.releaseInputStream();
                        final RemoteStub remStub = ubtRemoteObject.getRemStub();
                        try {
                    ...
                    case 15: {
                        remoteCall.releaseInputStream();
                        final IYodaRMI remoteManageObject = ubtRemoteObject.getRemoteManageObject();
                        try {
                        ...
                        final boolean rscLookedUp = ubtRemoteObject.getRscLookedUp(s2);
                        try {
                    ...
                    case 18: {
                        remoteCall.releaseInputStream();
                        final String[] schemaPropFnList = ubtRemoteObject.getSchemaPropFnList();
                        try {
                    ...
                    case 17: {
                        remoteCall.releaseInputStream();
                        final String schemaFilename = ubtRemoteObject.getSchemaFilename();
                        try {
                    ...
                    case 19: {
                        remoteCall.releaseInputStream();
                        final String svcName = ubtRemoteObject.getSvcName();
                        try {
                    ...
                    case 21: {
                        ...
                        Label_1405: {
                            ...
                            final IFileRef openFile = ubtRemoteObject.openFile(s3, eventListener);
                            try {
                        ...
                        ubtRemoteObject.regRscLookedUp(s4);
                        try {
    ...
    public Operation[] getOperations() {
        return UBTRemoteObject_Skel.operations.clone();
    }
}

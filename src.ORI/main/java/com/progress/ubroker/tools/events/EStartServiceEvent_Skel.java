...
public final class EStartServiceEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EStartServiceEvent eStartServiceEvent = (EStartServiceEvent)remote;
        Label_0984: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eStartServiceEvent.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eStartServiceEvent.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eStartServiceEvent.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eStartServiceEvent.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eStartServiceEvent.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eStartServiceEvent.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eStartServiceEvent.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String instanceName = eStartServiceEvent.getInstanceName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eStartServiceEvent.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eStartServiceEvent.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final IChimeraHierarchy pluginObj = eStartServiceEvent.getPluginObj();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String propGrpFullSpec = eStartServiceEvent.getPropGrpFullSpec();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eStartServiceEvent.getSeverityLevel();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String source = eStartServiceEvent.getSource();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eStartServiceEvent.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object guiID = eStartServiceEvent.guiID();
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eStartServiceEvent.issuerName();
                    try {
                    ...
                    eStartServiceEvent.setSource(source2);
                    try {
                ...
                case 19: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eStartServiceEvent.timeIssued();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eStartServiceEvent.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EStartServiceEvent_Skel.operations.clone();
    }
}

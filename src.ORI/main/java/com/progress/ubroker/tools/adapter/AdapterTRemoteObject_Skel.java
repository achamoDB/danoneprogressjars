...
public final class AdapterTRemoteObject_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final AdapterTRemoteObject adapterTRemoteObject = (AdapterTRemoteObject)remote;
        Label_0981: {
            while (true) {
                switch (n) {
                    case 0: {
                        remoteCall.releaseInputStream();
                        final String adminServerIPAddr = adapterTRemoteObject.getAdminServerIPAddr();
                        try {
                    ...
                    case 1: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrHost = adapterTRemoteObject.getAdminSrvrHost();
                        try {
                    ...
                    case 2: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrOSName = adapterTRemoteObject.getAdminSrvrOSName();
                        try {
                    ...
                    case 3: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrPort = adapterTRemoteObject.getAdminSrvrPort();
                        try {
                    ...
                    case 4: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrURL = adapterTRemoteObject.getAdminSrvrURL();
                        try {
                    ...
                    case 5: {
                        remoteCall.releaseInputStream();
                        final Enumeration children = adapterTRemoteObject.getChildren();
                        try {
                    ...
                    case 6: {
                        remoteCall.releaseInputStream();
                        final String displayName = adapterTRemoteObject.getDisplayName();
                        try {
                    ...
                    case 7: {
                        remoteCall.releaseInputStream();
                        final IEventBroker eventBroker = adapterTRemoteObject.getEventBroker();
                        try {
                        ...
                        final Hashtable logFiles = adapterTRemoteObject.getLogFiles(s);
                        try {
                    ...
                    case 9: {
                        remoteCall.releaseInputStream();
                        final String[] loginUserInfo = adapterTRemoteObject.getLoginUserInfo();
                        try {
                    ...
                    case 10: {
                        remoteCall.releaseInputStream();
                        final String mmcClientClass = adapterTRemoteObject.getMMCClientClass();
                        try {
                    ...
                    case 11: {
                        remoteCall.releaseInputStream();
                        final String propGroupPath = adapterTRemoteObject.getPropGroupPath();
                        try {
                    ...
                    case 12: {
                        remoteCall.releaseInputStream();
                        final String propertyFilename = adapterTRemoteObject.getPropertyFilename();
                        try {
                    ...
                    case 13: {
                        remoteCall.releaseInputStream();
                        final IPropertyManagerRemote rpm = adapterTRemoteObject.getRPM();
                        try {
                    ...
                    case 14: {
                        remoteCall.releaseInputStream();
                        final RemoteStub remStub = adapterTRemoteObject.getRemStub();
                        try {
                    ...
                    case 15: {
                        remoteCall.releaseInputStream();
                        final IYodaRMI remoteManageObject = adapterTRemoteObject.getRemoteManageObject();
                        try {
                        ...
                        final boolean rscLookedUp = adapterTRemoteObject.getRscLookedUp(s2);
                        try {
                    ...
                    case 18: {
                        remoteCall.releaseInputStream();
                        final String[] schemaPropFnList = adapterTRemoteObject.getSchemaPropFnList();
                        try {
                    ...
                    case 17: {
                        remoteCall.releaseInputStream();
                        final String schemaFilename = adapterTRemoteObject.getSchemaFilename();
                        try {
                    ...
                    case 19: {
                        remoteCall.releaseInputStream();
                        final String svcName = adapterTRemoteObject.getSvcName();
                        try {
                    ...
                    case 21: {
                        ...
                        Label_1405: {
                            ...
                            final IFileRef openFile = adapterTRemoteObject.openFile(s3, eventListener);
                            try {
                        ...
                        adapterTRemoteObject.regRscLookedUp(s4);
                        try {
    ...
    public Operation[] getOperations() {
        return AdapterTRemoteObject_Skel.operations.clone();
    }
}

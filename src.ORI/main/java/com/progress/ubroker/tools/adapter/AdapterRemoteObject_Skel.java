...
public final class AdapterRemoteObject_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final AdapterRemoteObject adapterRemoteObject = (AdapterRemoteObject)remote;
        Label_1114: {
            while (true) {
                switch (n) {
                    case 0: {
                        ...
                        final ToolRemoteCmdStatus doRemoteToolCmd = adapterRemoteObject.doRemoteToolCmd(toolRemoteCmdDescriptor);
                        try {
                    ...
                    case 1: {
                        remoteCall.releaseInputStream();
                        final String adminServerIPAddr = adapterRemoteObject.getAdminServerIPAddr();
                        try {
                    ...
                    case 2: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrHost = adapterRemoteObject.getAdminSrvrHost();
                        try {
                    ...
                    case 3: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrOSName = adapterRemoteObject.getAdminSrvrOSName();
                        try {
                    ...
                    case 4: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrPort = adapterRemoteObject.getAdminSrvrPort();
                        try {
                    ...
                    case 5: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrURL = adapterRemoteObject.getAdminSrvrURL();
                        try {
                    ...
                    case 6: {
                        remoteCall.releaseInputStream();
                        final Enumeration children = adapterRemoteObject.getChildren();
                        try {
                    ...
                    case 7: {
                        remoteCall.releaseInputStream();
                        final String displayName = adapterRemoteObject.getDisplayName();
                        try {
                    ...
                    case 8: {
                        remoteCall.releaseInputStream();
                        final IEventBroker eventBroker = adapterRemoteObject.getEventBroker();
                        try {
                        ...
                        final Hashtable logFiles = adapterRemoteObject.getLogFiles(s);
                        try {
                    ...
                    case 10: {
                        remoteCall.releaseInputStream();
                        final String[] loginUserInfo = adapterRemoteObject.getLoginUserInfo();
                        try {
                    ...
                    case 11: {
                        remoteCall.releaseInputStream();
                        final String mmcClientClass = adapterRemoteObject.getMMCClientClass();
                        try {
                    ...
                    case 12: {
                        remoteCall.releaseInputStream();
                        final String propGroupPath = adapterRemoteObject.getPropGroupPath();
                        try {
                    ...
                    case 13: {
                        remoteCall.releaseInputStream();
                        final String propertyFilename = adapterRemoteObject.getPropertyFilename();
                        try {
                    ...
                    case 14: {
                        remoteCall.releaseInputStream();
                        final IPropertyManagerRemote rpm = adapterRemoteObject.getRPM();
                        try {
                    ...
                    case 15: {
                        remoteCall.releaseInputStream();
                        final RemoteStub remStub = adapterRemoteObject.getRemStub();
                        try {
                    ...
                    case 16: {
                        remoteCall.releaseInputStream();
                        final IYodaRMI remoteManageObject = adapterRemoteObject.getRemoteManageObject();
                        try {
                        ...
                        final boolean rscLookedUp = adapterRemoteObject.getRscLookedUp(s2);
                        try {
                    ...
                    case 19: {
                        remoteCall.releaseInputStream();
                        final String[] schemaPropFnList = adapterRemoteObject.getSchemaPropFnList();
                        try {
                    ...
                    case 20: {
                        remoteCall.releaseInputStream();
                        final String svcName = adapterRemoteObject.getSvcName();
                        try {
                        ...
                        adapterRemoteObject.regRscLookedUp(s3);
                        try {
                    ...
                    case 18: {
                        remoteCall.releaseInputStream();
                        final String schemaFilename = adapterRemoteObject.getSchemaFilename();
                        try {
    ...
    public Operation[] getOperations() {
        return AdapterRemoteObject_Skel.operations.clone();
    }
}

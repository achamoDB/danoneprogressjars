...
public abstract class ProRuntimeException extends RuntimeException implements IChainableException
{
    ...
    protected ProRuntimeException(final String pattern, final long messageId, final Object[] arguments, final Throwable previous) {
    ...
    public ProRuntimeException(final long n, final Object[] array) {
        this(null, n, array, null);
    }
    
    public ProRuntimeException(final long n, final Object[] array, final Throwable t) {
        this(null, n, array, t);
    }
    
    public ProRuntimeException(final String s, final Object[] array) {
        this(s, 0L, array, null);
    }
    
    public ProRuntimeException(final String s, final Object[] array, final Throwable t) {
        this(s, 0L, array, t);
    }

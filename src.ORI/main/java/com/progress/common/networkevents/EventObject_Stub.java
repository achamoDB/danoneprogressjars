...
public final class EventObject_Stub extends RemoteStub implements IEventObject, Remote
{
    ...
    public EventObject_Stub() {
    }
    
    public EventObject_Stub(final RemoteRef ref) {
        super(ref);
    }
    
    public Class classDef() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EventObject_Stub.operations, 0, 6354199966435820571L);
    ...
    public String description() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EventObject_Stub.operations, 1, 6354199966435820571L);
            super.ref.invoke(call);
            String s;
            try {
    ...
    public String eventTypeString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EventObject_Stub.operations, 2, 6354199966435820571L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public boolean expedite() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EventObject_Stub.operations, 3, 6354199966435820571L);
            super.ref.invoke(call);
            boolean boolean1;
            try {
    ...
    public Object issuer() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EventObject_Stub.operations, 4, 6354199966435820571L);
            super.ref.invoke(call);
            Object object;
            try {
    ...
    public String issuerName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EventObject_Stub.operations, 5, 6354199966435820571L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Date timeIssued() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EventObject_Stub.operations, 6, 6354199966435820571L);
            super.ref.invoke(call);
            Date date;
            try {

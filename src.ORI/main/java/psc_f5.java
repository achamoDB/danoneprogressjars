...
public class psc_f5 extends psc_fz implements Cloneable, Serializable
{
    private byte[] a;
    psc_n b;
    ...
    public psc_f5(final byte[] array, final int n, final int n2) {
        this();
        this.f(array, n, n2);
    }
    ...
    protected void a(final byte[] array, final int n) throws psc_f0 {
        ...
        try {
            ...
            throw new psc_f0("Could not BER decode LocalKeyID.");
        }
    ...
    protected int d() {
        ...
        try {
            this.b = new psc_n(new psc_i[] { new psc_fo(0, true, 0), new psc_t(0, true, 0, this.a, 0, this.a.length), new psc_j() });
            return this.b.a();
        }
        catch (psc_m psc_m) {
            return 0;
    ...
    public Object clone() throws CloneNotSupportedException {
        final psc_f5 psc_f5 = new psc_f5();
        if (this.a != null) {
            psc_f5.a = this.a.clone();
        }
        super.a(psc_f5);
        return psc_f5;
    }
    ...
    public boolean equals(final Object o) {
        return o != null && o instanceof psc_f5 && psc_k4.a(((psc_f5)o).a, this.a);
    }

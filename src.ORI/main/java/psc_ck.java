...
public class psc_ck extends psc_aj implements Cloneable, Serializable, psc_bj
{
    private String a;
    psc_n b;
    ...
    public psc_ck() {
        ...
        super.bt = false;
        this.a(psc_aj.av);
        super.a = "VeriSignFidelityUniqueID";
    }
    
    public psc_ck(final String a, final boolean b) {
        super.bu = 110;
    ...
    public void d(final byte[] array, final int n) throws psc_g {
        ...
        try {
            ...
            throw new psc_g("Could not decode VeriSignFidelityUniqueID extension.");
        }
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        final psc_ck psc_ck = new psc_ck();
        psc_ck.a = this.a;
        if (this.b != null) {
            psc_ck.e();
        }

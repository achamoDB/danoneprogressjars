...
public class psc_ge extends psc_fz implements Cloneable, Serializable
{
    private int a;
    psc_n b;
    ...
    protected void a(final byte[] array, final int n) throws psc_f0 {
        ...
        try {
            ...
            throw new psc_f0("Could not BER decode VeriSignCRSVersion.");
        }
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        final psc_ge psc_ge = new psc_ge();
        if (this.a != -1) {
            psc_ge.a = this.a;
        }
        super.a(psc_ge);
    ...
    public boolean equals(final Object o) {
        return o != null && o instanceof psc_ge && this.a == ((psc_ge)o).a;
    }

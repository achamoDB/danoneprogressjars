...
class BasicCookieBox extends Frame
{
    ...
    BasicCookieBox() {
        ...
        this.addNotify();
        this.addWindowListener(new Close((BasicCookieBox.BasicCookieBox$1)null));
        ...
        this.default_focus.addActionListener(new Accept((BasicCookieBox.BasicCookieBox$1)null));
        this.constr.gridwidth = 0;
        Button b;
        this.add(b = new Button("Reject"), this.constr);
        b.addActionListener(new Reject((BasicCookieBox.BasicCookieBox$1)null));
        ...
        b.addActionListener(new AcceptDomain((BasicCookieBox.BasicCookieBox$1)null));
        this.constr.gridwidth = 0;
        this.add(b = new Button("Reject All"), this.constr);
        b.addActionListener(new RejectDomain((BasicCookieBox.BasicCookieBox$1)null));
        this.pack();
        this.constr.anchor = 17;
        this.constr.gridwidth = 0;
    }
    ...
    public synchronized boolean accept(final Cookie cookie, final DefaultCookiePolicyHandler h, final String server) {
        this.name_value_label.setText(cookie.getName() + "=" + cookie.getValue());
    ...
    private class Close extends WindowAdapter
    {
        public void windowClosing(final WindowEvent we) {
            new Reject((BasicCookieBox.BasicCookieBox$1)null).actionPerformed(null);
        }
    }
}

...
public class psc_jf extends psc_an implements psc_az, psc_ex, psc_ey, psc_er, Cloneable, Serializable
{
    protected int a;
    protected int b;
    protected int c;
    ...
    protected int g;
    protected int h;
    private final int i = 1779033703;
    private final int j = -1150833019;
    private final int k = 1013904242;
    private final int l = -1521486534;
    private final int m = 1359893119;
    private final int n = -1694144372;
    private final int o = 528734635;
    private final int p = 1541459225;
    protected int[] q;
    protected int r;
    private int[] s;
    ...
    public psc_jf(final int[] array) throws psc_be {
        this.q = new int[2];
        this.ac = new byte[64];
        this.ad = 1;
        this.af = new int[] { 1116352408, 1899447441, -1245643825, -373957723, 961987163, 1508970993, -1841331548, -1424204075, -670586216, 310598401, 607225278, 1426881987, 1925078388, -2132889090, -1680079193, -1046744716, -459576895, -272742522, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, -1740746414, -1473132947, -1341970488, -1084653625, -958395405, -710438585, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, -2117940946, -1838011259, -1564481375, -1474664885, -1035236496, -949202525, -778901479, -694614492, -200395387, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, -2067236844, -1933114872, -1866530822, -1538233109, -1090935817, -965641998 };
    ...
    public int a(final byte[] array, final int n, final byte[] array2, int n2) {
        final int n3 = psc_jf.ae.length + 32;
        System.arraycopy(psc_jf.ae, 0, array2, n2, psc_jf.ae.length);
        n2 += psc_jf.ae.length;
    ...
    void c(final byte[] array, int n) {
        ...
        ++n;
        array[n] = (byte)(this.h >>> 24 & 0xFF);
        ++n;
        array[n] = (byte)(this.h >> 16 & 0xFF);
        ++n;
        array[n] = (byte)(this.h >> 8 & 0xFF);
        ++n;
        array[n] = (byte)(this.h & 0xFF);
        ++n;
    }
    ...
    static {
        ae = new byte[] { 48, 49, 48, 13, 6, 9, 96, -122, 72, 1, 101, 3, 4, 2, 1, 5, 0, 4, 32 };
    }
}

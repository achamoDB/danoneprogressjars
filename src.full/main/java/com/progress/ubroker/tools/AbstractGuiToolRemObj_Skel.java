...
public final class AbstractGuiToolRemObj_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final AbstractGuiToolRemObj abstractGuiToolRemObj = (AbstractGuiToolRemObj)remote;
        Label_0981: {
            while (true) {
                switch (n) {
                    case 0: {
                        remoteCall.releaseInputStream();
                        final String adminServerIPAddr = abstractGuiToolRemObj.getAdminServerIPAddr();
                        try {
                    ...
                    case 1: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrHost = abstractGuiToolRemObj.getAdminSrvrHost();
                        try {
                    ...
                    case 2: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrOSName = abstractGuiToolRemObj.getAdminSrvrOSName();
                        try {
                    ...
                    case 3: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrPort = abstractGuiToolRemObj.getAdminSrvrPort();
                        try {
                    ...
                    case 4: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrURL = abstractGuiToolRemObj.getAdminSrvrURL();
                        try {
                    ...
                    case 5: {
                        remoteCall.releaseInputStream();
                        final Enumeration children = abstractGuiToolRemObj.getChildren();
                        try {
                    ...
                    case 6: {
                        remoteCall.releaseInputStream();
                        final String displayName = abstractGuiToolRemObj.getDisplayName();
                        try {
                    ...
                    case 7: {
                        remoteCall.releaseInputStream();
                        final IEventBroker eventBroker = abstractGuiToolRemObj.getEventBroker();
                        try {
                        ...
                        final Hashtable logFiles = abstractGuiToolRemObj.getLogFiles(s);
                        try {
                    ...
                    case 9: {
                        remoteCall.releaseInputStream();
                        final String[] loginUserInfo = abstractGuiToolRemObj.getLoginUserInfo();
                        try {
                    ...
                    case 10: {
                        remoteCall.releaseInputStream();
                        final String mmcClientClass = abstractGuiToolRemObj.getMMCClientClass();
                        try {
                    ...
                    case 11: {
                        remoteCall.releaseInputStream();
                        final String propGroupPath = abstractGuiToolRemObj.getPropGroupPath();
                        try {
                    ...
                    case 12: {
                        remoteCall.releaseInputStream();
                        final String propertyFilename = abstractGuiToolRemObj.getPropertyFilename();
                        try {
                    ...
                    case 13: {
                        remoteCall.releaseInputStream();
                        final IPropertyManagerRemote rpm = abstractGuiToolRemObj.getRPM();
                        try {
                    ...
                    case 14: {
                        remoteCall.releaseInputStream();
                        final RemoteStub remStub = abstractGuiToolRemObj.getRemStub();
                        try {
                    ...
                    case 15: {
                        remoteCall.releaseInputStream();
                        final IYodaRMI remoteManageObject = abstractGuiToolRemObj.getRemoteManageObject();
                        try {
                        ...
                        final boolean rscLookedUp = abstractGuiToolRemObj.getRscLookedUp(s2);
                        try {
                    ...
                    case 18: {
                        remoteCall.releaseInputStream();
                        final String[] schemaPropFnList = abstractGuiToolRemObj.getSchemaPropFnList();
                        try {
                    ...
                    case 17: {
                        remoteCall.releaseInputStream();
                        final String schemaFilename = abstractGuiToolRemObj.getSchemaFilename();
                        try {
                    ...
                    case 19: {
                        remoteCall.releaseInputStream();
                        final String svcName = abstractGuiToolRemObj.getSvcName();
                        try {
                    ...
                    case 21: {
                        ...
                        Label_1405: {
                            ...
                            final IFileRef openFile = abstractGuiToolRemObj.openFile(s3, eventListener);
                            try {
                        ...
                        abstractGuiToolRemObj.regRscLookedUp(s4);
                        try {
    ...
    public Operation[] getOperations() {
        return AbstractGuiToolRemObj_Skel.operations.clone();
    }
}

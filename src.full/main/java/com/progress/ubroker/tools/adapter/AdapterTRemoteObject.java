...
import com.progress.ubroker.tools.AbstractAdapterGuiToolRemObj;

public class AdapterTRemoteObject extends AbstractAdapterGuiToolRemObj implements IChimeraHierarchy, IYodaSharedResources, IBTMsgCodes
{
    static final String ADAPTERT_REMOTE_OBJ_NAME = "Adapter Tool Remote Object";
    String m_logInUser;
    ...
    public AdapterTRemoteObject(final IYodaRMI yodaRMI, final String s, final String s2, final String s3, final String s4, final String s5, final String s6, final String s7) throws RemoteException {
    ...
    protected NameContext getNameContext() {
        return AdapterTRemoteObject.nameTable;
    }
    
    public static AdapterTRemoteObject findAdapterTRemoteObject(final String s) {
        try {
            return AdapterTRemoteObject.nameTable.get(AbstractGuiToolRemObj.adjustName(s));
        }
        catch (Throwable t) {
            return null;
        }
    ...
    public String getMMCClientClass() throws RemoteException {
        return "com.progress.vj.ubroker.adapter.AdapterTMMCClient";
    }
    ...
    public String getApplicationName() throws RemoteException {
        return "Adapter Tool Remote Object";
    }
    ...
    static {
        AdapterTRemoteObject.nameTable = new NameContext();
    }
}

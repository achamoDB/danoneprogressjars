...
public class BooleanSerializer implements Serializer, Deserializer
{
    ...
    public Bean unmarshall(final String s, final QName qName, final Node node, final XMLJavaMappingRegistry xmlJavaMappingRegistry, final SOAPContext soapContext) throws IllegalArgumentException {
        ...
        if (null != attributeNS && (attributeNS.equals("true") || attributeNS.equals("1"))) {
            return new Bean(Boolean.class, (Object)null);
        }
        final String childCharacterData = DOMUtils.getChildCharacterData(element);
        if (childCharacterData.equals("true") || childCharacterData.equals("1")) {
            return new Bean(Boolean.class, (Object)new Boolean("true"));
        }
        if (childCharacterData.equals("false") || childCharacterData.equals("0")) {
            return new Bean(Boolean.class, (Object)new Boolean("false"));
        }
        throw new IllegalArgumentException("Invalid boolean value '" + childCharacterData + "' sent to deserializer");
    }
}

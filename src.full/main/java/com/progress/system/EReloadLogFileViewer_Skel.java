...
public final class EReloadLogFileViewer_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EReloadLogFileViewer eReloadLogFileViewer = (EReloadLogFileViewer)remote;
        Label_0776: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eReloadLogFileViewer.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eReloadLogFileViewer.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eReloadLogFileViewer.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eReloadLogFileViewer.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eReloadLogFileViewer.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eReloadLogFileViewer.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eReloadLogFileViewer.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eReloadLogFileViewer.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eReloadLogFileViewer.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eReloadLogFileViewer.getSeverityLevel();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final String source = eReloadLogFileViewer.getSource();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eReloadLogFileViewer.getSubCategory();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eReloadLogFileViewer.issuerName();
                    try {
                    ...
                    eReloadLogFileViewer.setSource(source2);
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eReloadLogFileViewer.timeIssued();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eReloadLogFileViewer.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EReloadLogFileViewer_Skel.operations.clone();
    }
}

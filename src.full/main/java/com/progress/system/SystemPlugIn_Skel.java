...
public final class SystemPlugIn_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -3735122454478133727L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final SystemPlugIn systemPlugIn = (SystemPlugIn)remote;
        switch (n) {
            case 0: {
                remoteCall.releaseInputStream();
                final IAdministrationServer adminServer = systemPlugIn.getAdminServer();
                try {
            ...
            case 1: {
                remoteCall.releaseInputStream();
                final IEventBroker eventBroker = systemPlugIn.getEventBroker();
                try {
            ...
            case 2: {
                remoteCall.releaseInputStream();
                final IEventStream eventStream = systemPlugIn.getEventStream();
                try {
            ...
            case 3: {
                remoteCall.releaseInputStream();
                final ILicenseMgr licenseManager = systemPlugIn.getLicenseManager();
                try {
            ...
            case 4: {
                remoteCall.releaseInputStream();
                final String os = systemPlugIn.getOS();
                try {
            ...
            case 5: {
                remoteCall.releaseInputStream();
                final ISystemPlugIn plugIn = systemPlugIn.getPlugIn();
                try {
    ...
    public Operation[] getOperations() {
        return SystemPlugIn_Skel.operations.clone();
    }
}

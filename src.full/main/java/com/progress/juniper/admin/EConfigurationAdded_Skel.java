...
public final class EConfigurationAdded_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -7424427550955567861L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EConfigurationAdded eConfigurationAdded = (EConfigurationAdded)remote;
        Label_0984: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eConfigurationAdded.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJAConfiguration configuration = eConfigurationAdded.configuration();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eConfigurationAdded.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eConfigurationAdded.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eConfigurationAdded.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eConfigurationAdded.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object child = eConfigurationAdded.getChild();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String errorString = eConfigurationAdded.getErrorString();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eConfigurationAdded.getEventData();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eConfigurationAdded.getNotificationName();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eConfigurationAdded.getNotificationType();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final Object object = eConfigurationAdded.getObject();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eConfigurationAdded.getSeverityLevel();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String source = eConfigurationAdded.getSource();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eConfigurationAdded.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object guiID = eConfigurationAdded.guiID();
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eConfigurationAdded.issuerName();
                    try {
                    ...
                    eConfigurationAdded.setSource(source2);
                    try {
                ...
                case 19: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eConfigurationAdded.timeIssued();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eConfigurationAdded.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EConfigurationAdded_Skel.operations.clone();
    }
}

...
public final class EConfigurationRemoved_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -3092750500477704221L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EConfigurationRemoved eConfigurationRemoved = (EConfigurationRemoved)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eConfigurationRemoved.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJAConfiguration configuration = eConfigurationRemoved.configuration();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eConfigurationRemoved.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eConfigurationRemoved.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eConfigurationRemoved.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eConfigurationRemoved.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eConfigurationRemoved.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eConfigurationRemoved.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eConfigurationRemoved.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eConfigurationRemoved.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eConfigurationRemoved.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eConfigurationRemoved.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eConfigurationRemoved.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eConfigurationRemoved.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eConfigurationRemoved.issuerName();
                    try {
                    ...
                    eConfigurationRemoved.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eConfigurationRemoved.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eConfigurationRemoved.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EConfigurationRemoved_Skel.operations.clone();
    }
}

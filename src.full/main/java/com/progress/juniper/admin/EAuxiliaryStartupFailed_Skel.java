...
public final class EAuxiliaryStartupFailed_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 3666400897412646806L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EAuxiliaryStartupFailed eAuxiliaryStartupFailed = (EAuxiliaryStartupFailed)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final IJAAuxiliary auxiliary = eAuxiliaryStartupFailed.auxiliary();
                    try {
                        remoteCall.getResultStream(true).writeObject(auxiliary);
                        return;
                    }
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eAuxiliaryStartupFailed.classDef();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eAuxiliaryStartupFailed.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eAuxiliaryStartupFailed.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eAuxiliaryStartupFailed.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eAuxiliaryStartupFailed.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eAuxiliaryStartupFailed.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eAuxiliaryStartupFailed.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eAuxiliaryStartupFailed.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eAuxiliaryStartupFailed.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eAuxiliaryStartupFailed.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eAuxiliaryStartupFailed.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eAuxiliaryStartupFailed.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eAuxiliaryStartupFailed.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eAuxiliaryStartupFailed.issuer();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String reasonForFailure = eAuxiliaryStartupFailed.reasonForFailure();
                    try {
                    ...
                    eAuxiliaryStartupFailed.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eAuxiliaryStartupFailed.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eAuxiliaryStartupFailed.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EAuxiliaryStartupFailed_Skel.operations.clone();
    }
}

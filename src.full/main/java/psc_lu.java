...
public final class psc_lu extends psc_an
{
    public static void a(final psc_dn psc_dn, final psc_dg psc_dg, final byte[] array, final int n, final int n2) throws psc_ao {
    ...
    public static byte[] a(final int n, final byte[] array) throws psc_ao {
        if (n < 1) {
            throw new psc_ao("Cannot DER encode PKCS #5 PBE, no iteration count.");
        }
        if (array == null || array.length < 8) {
            throw new psc_ao("Cannot DER encode PKCS #5 PBE, invalid salt.");
        }
        try {

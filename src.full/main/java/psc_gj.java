...
public class psc_gj extends psc_fz implements Cloneable, Serializable
{
    private String a;
    private int b;
    psc_n c;
    ...
    public psc_gj(final String s, final int n) throws psc_f0 {
        this();
        this.a(s, n);
    }
    ...
    protected void a(final byte[] array, final int n) throws psc_f0 {
        ...
        try {
            ...
            throw new psc_f0("Could not BER decode Pseudonym." + psc_m.getMessage());
        }
    }
    
    public void a(final String a, final int b) throws psc_f0 {
        if (a == null) {
            throw new psc_f0("Pseudonym is null.");
        }
        this.e();
        this.a = a;
    ...
    public Object clone() throws CloneNotSupportedException {
        final psc_gj psc_gj = new psc_gj();
        if (this.a != null) {
            psc_gj.a = this.a;
        }
        psc_gj.b = this.b;
    ...
    public boolean equals(final Object o) {
        if (o == null || !(o instanceof psc_gj)) {
            return false;
        }
        final psc_gj psc_gj = (psc_gj)o;
        if (this.a == null) {
            return psc_gj.a == null;
        }
        return psc_gj.a != null && this.a.equals(psc_gj.a);
    }

...
public final class pscl_aq implements pscl_d, Cloneable
{
    private int a;
    private int b;
    private int c;
    ...
    public pscl_aq(final int[] array) {
        this.e = new int[16];
        this.g = new byte[64];
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        pscl_aq.d = this.d;
        if (this.e != null) {
            pscl_aq.e = this.e.clone();
        }
        pscl_aq.f = this.f;
        if (this.g != null) {
            pscl_aq.g = this.g.clone();
        }
        pscl_aq.i = this.i;
        return pscl_aq;
    }
    ...
    private void b(final byte[] array, int n) {
        final int a = this.a;
        final int b = this.b;
        final int c = this.c;
        final int d = this.d;

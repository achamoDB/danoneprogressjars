...
public final class ESystemObject_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final ESystemObject eSystemObject = (ESystemObject)remote;
        Label_0776: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eSystemObject.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eSystemObject.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eSystemObject.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eSystemObject.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eSystemObject.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eSystemObject.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eSystemObject.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eSystemObject.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eSystemObject.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eSystemObject.getSeverityLevel();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final String source = eSystemObject.getSource();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eSystemObject.getSubCategory();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eSystemObject.issuerName();
                    try {
                    ...
                    eSystemObject.setSource(source2);
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eSystemObject.timeIssued();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eSystemObject.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return ESystemObject_Skel.operations.clone();
    }
}

...
public final class ChimeraContainerEventSuper_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final ChimeraContainerEventSuper chimeraContainerEventSuper = (ChimeraContainerEventSuper)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = chimeraContainerEventSuper.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = chimeraContainerEventSuper.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = chimeraContainerEventSuper.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = chimeraContainerEventSuper.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = chimeraContainerEventSuper.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = chimeraContainerEventSuper.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = chimeraContainerEventSuper.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final IChimeraHierarchy nodeObj = chimeraContainerEventSuper.getNodeObj();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = chimeraContainerEventSuper.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = chimeraContainerEventSuper.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final IChimeraHierarchy parentNode = chimeraContainerEventSuper.getParentNode();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = chimeraContainerEventSuper.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = chimeraContainerEventSuper.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = chimeraContainerEventSuper.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object guiID = chimeraContainerEventSuper.guiID();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String issuerName = chimeraContainerEventSuper.issuerName();
                    try {
                    ...
                    chimeraContainerEventSuper.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = chimeraContainerEventSuper.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object issuer = chimeraContainerEventSuper.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return ChimeraContainerEventSuper_Skel.operations.clone();
    }
}

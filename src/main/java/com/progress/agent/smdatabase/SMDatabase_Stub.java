...
public final class SMDatabase_Stub extends RemoteStub implements ISMDatabase, IChimeraHierarchy, IChimeraRemoteObject
{
    ...
    public SMDatabase_Stub() {
    }
    
    public SMDatabase_Stub(final RemoteRef ref) {
        super(ref);
    }
    
    public Enumeration getChildren() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, SMDatabase_Stub.operations, 0, -3634889999576623773L);
    ...
    public String getDisplayName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, SMDatabase_Stub.operations, 1, -3634889999576623773L);
            super.ref.invoke(call);
            String s;
            try {
    ...
    public String getMMCClientClass() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, SMDatabase_Stub.operations, 2, -3634889999576623773L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();

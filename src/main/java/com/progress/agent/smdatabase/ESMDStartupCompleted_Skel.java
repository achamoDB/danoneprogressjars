...
public final class ESMDStartupCompleted_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final ESMDStartupCompleted esmdStartupCompleted = (ESMDStartupCompleted)remote;
        Label_0828: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = esmdStartupCompleted.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = esmdStartupCompleted.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = esmdStartupCompleted.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = esmdStartupCompleted.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = esmdStartupCompleted.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = esmdStartupCompleted.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = esmdStartupCompleted.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = esmdStartupCompleted.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = esmdStartupCompleted.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = esmdStartupCompleted.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = esmdStartupCompleted.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = esmdStartupCompleted.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = esmdStartupCompleted.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String issuerName = esmdStartupCompleted.issuerName();
                    try {
                    ...
                    esmdStartupCompleted.setSource(source2);
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = esmdStartupCompleted.timeIssued();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object issuer = esmdStartupCompleted.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return ESMDStartupCompleted_Skel.operations.clone();
    }
}

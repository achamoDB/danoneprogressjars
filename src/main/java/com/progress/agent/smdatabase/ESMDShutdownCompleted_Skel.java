...
public final class ESMDShutdownCompleted_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final ESMDShutdownCompleted esmdShutdownCompleted = (ESMDShutdownCompleted)remote;
        Label_0828: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = esmdShutdownCompleted.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = esmdShutdownCompleted.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = esmdShutdownCompleted.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = esmdShutdownCompleted.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = esmdShutdownCompleted.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = esmdShutdownCompleted.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = esmdShutdownCompleted.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = esmdShutdownCompleted.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = esmdShutdownCompleted.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = esmdShutdownCompleted.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = esmdShutdownCompleted.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = esmdShutdownCompleted.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = esmdShutdownCompleted.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String issuerName = esmdShutdownCompleted.issuerName();
                    try {
                    ...
                    esmdShutdownCompleted.setSource(source2);
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = esmdShutdownCompleted.timeIssued();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object issuer = esmdShutdownCompleted.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return ESMDShutdownCompleted_Skel.operations.clone();
    }
}

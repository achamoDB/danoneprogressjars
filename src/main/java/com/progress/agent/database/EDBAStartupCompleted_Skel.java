...
public final class EDBAStartupCompleted_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EDBAStartupCompleted edbaStartupCompleted = (EDBAStartupCompleted)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final IAgentDatabase agent = edbaStartupCompleted.agent();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final Class classDef = edbaStartupCompleted.classDef();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = edbaStartupCompleted.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = edbaStartupCompleted.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = edbaStartupCompleted.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = edbaStartupCompleted.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = edbaStartupCompleted.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = edbaStartupCompleted.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = edbaStartupCompleted.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = edbaStartupCompleted.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = edbaStartupCompleted.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = edbaStartupCompleted.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = edbaStartupCompleted.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = edbaStartupCompleted.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = edbaStartupCompleted.issuerName();
                    try {
                    ...
                    edbaStartupCompleted.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = edbaStartupCompleted.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = edbaStartupCompleted.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EDBAStartupCompleted_Skel.operations.clone();
    }
}

...
public final class EDBAStateChanged_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -2064864913991294505L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EDBAStateChanged edbaStateChanged = (EDBAStateChanged)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final IAgentDatabase agent = edbaStateChanged.agent();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final Class classDef = edbaStateChanged.classDef();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = edbaStateChanged.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = edbaStateChanged.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = edbaStateChanged.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = edbaStateChanged.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = edbaStateChanged.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = edbaStateChanged.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = edbaStateChanged.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = edbaStateChanged.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = edbaStateChanged.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = edbaStateChanged.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = edbaStateChanged.getSource();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = edbaStateChanged.getSubCategory();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String issuerName = edbaStateChanged.issuerName();
                    try {
                    ...
                    edbaStateChanged.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = edbaStateChanged.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object issuer = edbaStateChanged.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EDBAStateChanged_Skel.operations.clone();
    }
}

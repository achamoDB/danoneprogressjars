...
public final class EPropertyEvent_Stub extends RemoteStub implements IEClientSpecificEvent, IEventObject, Remote
{
    ...
    public EPropertyEvent_Stub() {
    }
    
    public EPropertyEvent_Stub(final RemoteRef ref) {
        super(ref);
    }
    
    public Class classDef() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EPropertyEvent_Stub.operations, 0, -1083964403996589029L);
    ...
    public String description() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EPropertyEvent_Stub.operations, 1, -1083964403996589029L);
            super.ref.invoke(call);
            String s;
            try {
    ...
    public String eventTypeString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EPropertyEvent_Stub.operations, 2, -1083964403996589029L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public boolean expedite() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EPropertyEvent_Stub.operations, 3, -1083964403996589029L);
            super.ref.invoke(call);
            boolean boolean1;
            try {
    ...
    public Object guiID() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EPropertyEvent_Stub.operations, 4, -1083964403996589029L);
            super.ref.invoke(call);
            Object object;
            try {
    ...
    public Object issuer() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EPropertyEvent_Stub.operations, 5, -1083964403996589029L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public String issuerName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EPropertyEvent_Stub.operations, 6, -1083964403996589029L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Date timeIssued() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EPropertyEvent_Stub.operations, 7, -1083964403996589029L);
            super.ref.invoke(call);
            Date date;
            try {

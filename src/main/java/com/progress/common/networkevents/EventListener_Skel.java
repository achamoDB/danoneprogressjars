...
public final class EventListener_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EventListener eventListener = (EventListener)remote;
        switch (n) {
            case 0: {
                ...
                eventListener.processEvent(eventObject);
                try {
    ...
    public Operation[] getOperations() {
        return EventListener_Skel.operations.clone();
    }
}

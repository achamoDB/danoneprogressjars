...
public class ParameterResultSet implements ResultSet
{
    private ParameterSet params;
    private int numParam;
    private int currentRow;
    
    ParameterResultSet(final ParameterSet set) {
        this.init(set);
    }
    
    void reset(final ParameterSet set) {
        this.init(set);
    }
    
    private void init(final ParameterSet params) {
        this.params = params;
        this.numParam = this.params.getNumParams();
        this.currentRow = 0;
    }
    
    public boolean next() throws Open4GLError {
        ++this.currentRow;
        return this.currentRow <= this.numParam;
    }
    ...
    public boolean isMappedTable() throws Open4GLError {
        return this.params.isMappedTable(this.currentRow);
    }
    
    public int getMappedTableType() throws Open4GLError {
        return this.params.getMappedTableType(this.currentRow);
    }
    
    public Object getObject(final int n) throws Open4GLError {
        switch (n) {
            case 1: {
                return new Integer(this.params.getProType(this.currentRow));
            }
            case 2: {
                return this.params.getValue(this.currentRow);
            }
            case 3: {
                return new Integer(this.params.getMode(this.currentRow));
            }
            case 4: {
                return new Boolean(this.params.getIsExtent(this.currentRow));
            }
            case 5: {
                return new Integer(this.params.getExtentValue(this.currentRow));
            }
            case 6: {
                return new Integer(this.params.getFlags(this.currentRow));
            }
            default: {

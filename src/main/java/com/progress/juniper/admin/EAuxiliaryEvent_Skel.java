...
public final class EAuxiliaryEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EAuxiliaryEvent eAuxiliaryEvent = (EAuxiliaryEvent)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final IJAAuxiliary auxiliary = eAuxiliaryEvent.auxiliary();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eAuxiliaryEvent.classDef();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eAuxiliaryEvent.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eAuxiliaryEvent.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eAuxiliaryEvent.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eAuxiliaryEvent.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eAuxiliaryEvent.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eAuxiliaryEvent.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eAuxiliaryEvent.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eAuxiliaryEvent.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eAuxiliaryEvent.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eAuxiliaryEvent.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eAuxiliaryEvent.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eAuxiliaryEvent.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eAuxiliaryEvent.issuerName();
                    try {
                    ...
                    eAuxiliaryEvent.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eAuxiliaryEvent.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eAuxiliaryEvent.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EAuxiliaryEvent_Skel.operations.clone();
    }
}

...
public final class EPropertyChangedEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -6408105111879483250L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EPropertyChangedEvent ePropertyChangedEvent = (EPropertyChangedEvent)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = ePropertyChangedEvent.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = ePropertyChangedEvent.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = ePropertyChangedEvent.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = ePropertyChangedEvent.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = ePropertyChangedEvent.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = ePropertyChangedEvent.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = ePropertyChangedEvent.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = ePropertyChangedEvent.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = ePropertyChangedEvent.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = ePropertyChangedEvent.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = ePropertyChangedEvent.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = ePropertyChangedEvent.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = ePropertyChangedEvent.getSubCategory();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object guiID = ePropertyChangedEvent.guiID();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = ePropertyChangedEvent.issuerName();
                    try {
                    ...
                    ePropertyChangedEvent.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = ePropertyChangedEvent.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = ePropertyChangedEvent.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EPropertyChangedEvent_Skel.operations.clone();
    }
}

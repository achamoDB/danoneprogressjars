...
public final class EStartupProcessException_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EStartupProcessException ex = (EStartupProcessException)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = ex.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJADatabase database = ex.database();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = ex.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = ex.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = ex.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = ex.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = ex.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = ex.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = ex.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = ex.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = ex.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = ex.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = ex.getSubCategory();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String reasonForFailure = ex.reasonForFailure();
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = ex.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = ex.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EStartupProcessException_Skel.operations.clone();
    }
}

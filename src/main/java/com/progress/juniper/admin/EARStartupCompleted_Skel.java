...
public final class EARStartupCompleted_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 4023726477524062077L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EARStartupCompleted earStartupCompleted = (EARStartupCompleted)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final IJAAgent agent = earStartupCompleted.agent();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final Class classDef = earStartupCompleted.classDef();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = earStartupCompleted.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = earStartupCompleted.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = earStartupCompleted.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = earStartupCompleted.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = earStartupCompleted.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = earStartupCompleted.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = earStartupCompleted.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = earStartupCompleted.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = earStartupCompleted.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = earStartupCompleted.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = earStartupCompleted.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = earStartupCompleted.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = earStartupCompleted.issuerName();
                    try {
                    ...
                    earStartupCompleted.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = earStartupCompleted.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = earStartupCompleted.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EARStartupCompleted_Skel.operations.clone();
    }
}

...
public final class EAuxiliaryStartupEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -3601037182364071180L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EAuxiliaryStartupEvent eAuxiliaryStartupEvent = (EAuxiliaryStartupEvent)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final IJAAuxiliary auxiliary = eAuxiliaryStartupEvent.auxiliary();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eAuxiliaryStartupEvent.classDef();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eAuxiliaryStartupEvent.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eAuxiliaryStartupEvent.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eAuxiliaryStartupEvent.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eAuxiliaryStartupEvent.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eAuxiliaryStartupEvent.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eAuxiliaryStartupEvent.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eAuxiliaryStartupEvent.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eAuxiliaryStartupEvent.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eAuxiliaryStartupEvent.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eAuxiliaryStartupEvent.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eAuxiliaryStartupEvent.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eAuxiliaryStartupEvent.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eAuxiliaryStartupEvent.issuerName();
                    try {
                    ...
                    eAuxiliaryStartupEvent.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eAuxiliaryStartupEvent.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eAuxiliaryStartupEvent.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EAuxiliaryStartupEvent_Skel.operations.clone();
    }
}

...
public final class EDatabasePropertyChangedEvent_Stub extends RemoteStub implements IEDatabaseEvent, IEClientSpecificEvent, IEJAEvent, INotificationEvent, IEventObject, Remote
{
    ...
    public EDatabasePropertyChangedEvent_Stub() {
    }
    
    public EDatabasePropertyChangedEvent_Stub(final RemoteRef ref) {
        super(ref);
    }
    
    public Class classDef() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 0, 6540680109947361358L);
    ...
    public IJADatabase database() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 1, 6540680109947361358L);
            super.ref.invoke(call);
    ...
    public String description() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 2, 6540680109947361358L);
            super.ref.invoke(call);
            String s;
            try {
    ...
    public String eventTypeString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 3, 6540680109947361358L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public boolean expedite() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 4, 6540680109947361358L);
            super.ref.invoke(call);
            boolean boolean1;
            try {
    ...
    public short getCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 5, 6540680109947361358L);
            super.ref.invoke(call);
            short short1;
            try {
    ...
    public String getErrorString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 6, 6540680109947361358L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getEventData() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 7, 6540680109947361358L);
            super.ref.invoke(call);
            Object object;
            try {
    ...
    public String getNotificationName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 8, 6540680109947361358L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getNotificationType() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 9, 6540680109947361358L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getObject() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 10, 6540680109947361358L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public int getSeverityLevel() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 11, 6540680109947361358L);
            super.ref.invoke(call);
            int int1;
            try {
    ...
    public String getSource() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 12, 6540680109947361358L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getSubCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 13, 6540680109947361358L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object guiID() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 14, 6540680109947361358L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public Object issuer() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 15, 6540680109947361358L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public String issuerName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 16, 6540680109947361358L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public void setSource(final String s) throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 17, 6540680109947361358L);
            try {
    ...
    public Date timeIssued() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabasePropertyChangedEvent_Stub.operations, 18, 6540680109947361358L);
            super.ref.invoke(call);
            Date date;
            try {

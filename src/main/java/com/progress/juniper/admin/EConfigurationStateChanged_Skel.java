...
public final class EConfigurationStateChanged_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 8665737162927578112L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EConfigurationStateChanged eConfigurationStateChanged = (EConfigurationStateChanged)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eConfigurationStateChanged.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJAConfiguration configuration = eConfigurationStateChanged.configuration();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eConfigurationStateChanged.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eConfigurationStateChanged.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eConfigurationStateChanged.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eConfigurationStateChanged.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eConfigurationStateChanged.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eConfigurationStateChanged.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eConfigurationStateChanged.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eConfigurationStateChanged.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eConfigurationStateChanged.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eConfigurationStateChanged.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eConfigurationStateChanged.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final JAStatusObject status = eConfigurationStateChanged.getStatus();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eConfigurationStateChanged.getSubCategory();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eConfigurationStateChanged.issuerName();
                    try {
                    ...
                    eConfigurationStateChanged.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eConfigurationStateChanged.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eConfigurationStateChanged.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EConfigurationStateChanged_Skel.operations.clone();
    }
}

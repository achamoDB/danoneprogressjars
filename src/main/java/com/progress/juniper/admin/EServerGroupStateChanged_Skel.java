...
public final class EServerGroupStateChanged_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -4632541540636304520L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EServerGroupStateChanged eServerGroupStateChanged = (EServerGroupStateChanged)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eServerGroupStateChanged.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eServerGroupStateChanged.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eServerGroupStateChanged.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eServerGroupStateChanged.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eServerGroupStateChanged.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eServerGroupStateChanged.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eServerGroupStateChanged.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eServerGroupStateChanged.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eServerGroupStateChanged.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = eServerGroupStateChanged.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eServerGroupStateChanged.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = eServerGroupStateChanged.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final JAStatusObject status = eServerGroupStateChanged.getStatus();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eServerGroupStateChanged.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eServerGroupStateChanged.issuer();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final IJAService serverGroup = eServerGroupStateChanged.serverGroup();
                    try {
                    ...
                    eServerGroupStateChanged.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eServerGroupStateChanged.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eServerGroupStateChanged.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EServerGroupStateChanged_Skel.operations.clone();
    }
}

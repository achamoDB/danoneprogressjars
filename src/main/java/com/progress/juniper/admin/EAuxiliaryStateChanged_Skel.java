...
public final class EAuxiliaryStateChanged_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != -7617174707337618648L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EAuxiliaryStateChanged eAuxiliaryStateChanged = (EAuxiliaryStateChanged)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final IJAAuxiliary auxiliary = eAuxiliaryStateChanged.auxiliary();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eAuxiliaryStateChanged.classDef();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eAuxiliaryStateChanged.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eAuxiliaryStateChanged.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eAuxiliaryStateChanged.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eAuxiliaryStateChanged.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eAuxiliaryStateChanged.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eAuxiliaryStateChanged.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eAuxiliaryStateChanged.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eAuxiliaryStateChanged.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eAuxiliaryStateChanged.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eAuxiliaryStateChanged.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eAuxiliaryStateChanged.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final JAStatusObject status = eAuxiliaryStateChanged.getStatus();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eAuxiliaryStateChanged.getSubCategory();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eAuxiliaryStateChanged.issuerName();
                    try {
                    ...
                    eAuxiliaryStateChanged.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eAuxiliaryStateChanged.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eAuxiliaryStateChanged.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EAuxiliaryStateChanged_Skel.operations.clone();
    }
}

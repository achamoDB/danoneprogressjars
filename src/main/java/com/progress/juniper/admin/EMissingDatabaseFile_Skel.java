...
public final class EMissingDatabaseFile_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EMissingDatabaseFile eMissingDatabaseFile = (EMissingDatabaseFile)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eMissingDatabaseFile.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJADatabase database = eMissingDatabaseFile.database();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eMissingDatabaseFile.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eMissingDatabaseFile.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eMissingDatabaseFile.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eMissingDatabaseFile.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eMissingDatabaseFile.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eMissingDatabaseFile.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eMissingDatabaseFile.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eMissingDatabaseFile.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final Object object = eMissingDatabaseFile.getObject();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eMissingDatabaseFile.getSeverityLevel();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String source = eMissingDatabaseFile.getSource();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eMissingDatabaseFile.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eMissingDatabaseFile.issuer();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String reasonForFailure = eMissingDatabaseFile.reasonForFailure();
                    try {
                    ...
                    eMissingDatabaseFile.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eMissingDatabaseFile.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eMissingDatabaseFile.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EMissingDatabaseFile_Skel.operations.clone();
    }
}

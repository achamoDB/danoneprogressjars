...
public final class EServerGroupDeleted_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EServerGroupDeleted eServerGroupDeleted = (EServerGroupDeleted)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eServerGroupDeleted.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eServerGroupDeleted.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eServerGroupDeleted.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eServerGroupDeleted.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eServerGroupDeleted.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eServerGroupDeleted.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eServerGroupDeleted.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eServerGroupDeleted.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eServerGroupDeleted.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = eServerGroupDeleted.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eServerGroupDeleted.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = eServerGroupDeleted.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eServerGroupDeleted.getSubCategory();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object guiID = eServerGroupDeleted.guiID();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eServerGroupDeleted.issuer();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final IJAService serverGroup = eServerGroupDeleted.serverGroup();
                    try {
                    ...
                    eServerGroupDeleted.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eServerGroupDeleted.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eServerGroupDeleted.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EServerGroupDeleted_Skel.operations.clone();
    }
}

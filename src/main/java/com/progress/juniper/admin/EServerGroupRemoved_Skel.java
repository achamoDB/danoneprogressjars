...
public final class EServerGroupRemoved_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 4882125973180720048L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EServerGroupRemoved eServerGroupRemoved = (EServerGroupRemoved)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eServerGroupRemoved.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eServerGroupRemoved.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eServerGroupRemoved.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eServerGroupRemoved.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eServerGroupRemoved.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eServerGroupRemoved.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eServerGroupRemoved.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eServerGroupRemoved.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eServerGroupRemoved.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = eServerGroupRemoved.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eServerGroupRemoved.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = eServerGroupRemoved.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eServerGroupRemoved.getSubCategory();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eServerGroupRemoved.issuer();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final IJAService serverGroup = eServerGroupRemoved.serverGroup();
                    try {
                    ...
                    eServerGroupRemoved.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eServerGroupRemoved.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eServerGroupRemoved.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EServerGroupRemoved_Skel.operations.clone();
    }
}

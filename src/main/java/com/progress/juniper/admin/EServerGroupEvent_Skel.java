...
public final class EServerGroupEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EServerGroupEvent eServerGroupEvent = (EServerGroupEvent)remote;
        Label_0880: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eServerGroupEvent.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eServerGroupEvent.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eServerGroupEvent.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eServerGroupEvent.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eServerGroupEvent.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eServerGroupEvent.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eServerGroupEvent.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eServerGroupEvent.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eServerGroupEvent.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = eServerGroupEvent.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eServerGroupEvent.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = eServerGroupEvent.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eServerGroupEvent.getSubCategory();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eServerGroupEvent.issuer();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final IJAService serverGroup = eServerGroupEvent.serverGroup();
                    try {
                    ...
                    eServerGroupEvent.setSource(source2);
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eServerGroupEvent.timeIssued();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eServerGroupEvent.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EServerGroupEvent_Skel.operations.clone();
    }
}

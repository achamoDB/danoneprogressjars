...
public final class EStartupProcessFailure_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EStartupProcessFailure eStartupProcessFailure = (EStartupProcessFailure)remote;
        Label_0984: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eStartupProcessFailure.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final IJADatabase database = eStartupProcessFailure.database();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String description = eStartupProcessFailure.description();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eStartupProcessFailure.eventTypeString();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eStartupProcessFailure.expedite();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final short category = eStartupProcessFailure.getCategory();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eStartupProcessFailure.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eStartupProcessFailure.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final IEventObject nestedEvent = eStartupProcessFailure.getNestedEvent();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eStartupProcessFailure.getNotificationName();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eStartupProcessFailure.getNotificationType();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final Object object = eStartupProcessFailure.getObject();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eStartupProcessFailure.getSeverityLevel();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String source = eStartupProcessFailure.getSource();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eStartupProcessFailure.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eStartupProcessFailure.issuer();
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final String reasonForFailure = eStartupProcessFailure.reasonForFailure();
                    try {
                    ...
                    eStartupProcessFailure.setSource(source2);
                    try {
                ...
                case 19: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eStartupProcessFailure.timeIssued();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eStartupProcessFailure.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EStartupProcessFailure_Skel.operations.clone();
    }
}

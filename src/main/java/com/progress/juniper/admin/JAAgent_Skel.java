...
public final class JAAgent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 1412165292470283356L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final JAAgent jaAgent = (JAAgent)remote;
        Label_0686: {
            switch (n) {
                case 0: {
                    try {
                ...
                case 1: {
                    Label_0269: {
                        break Label_0269;
                        final String s;
                        final boolean childNameUsed = jaAgent.childNameUsed(s);
                        try {
                ...
                case 2: {
                    ...
                    Label_0424: {
                        ...
                        final IJAHierarchy child = jaAgent.createChild(s2, object, object2);
                        try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final Enumeration children = jaAgent.getChildren();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final Enumeration childrenObjects = jaAgent.getChildrenObjects();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String displayName = jaAgent.getDisplayName();
                    try {
                    ...
                    final String displayName2 = jaAgent.getDisplayName(boolean1);
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String mmcClientClass = jaAgent.getMMCClientClass();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final IJAHierarchy parent = jaAgent.getParent();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final IJAPlugIn plugIn = jaAgent.getPlugIn();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final String stateDescriptor = jaAgent.getStateDescriptor();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final JAStatusObject status = jaAgent.getStatus();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final boolean deleteable = jaAgent.isDeleteable();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final boolean idle = jaAgent.isIdle();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final boolean initializing = jaAgent.isInitializing();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final boolean running = jaAgent.isRunning();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final boolean shuttingDown = jaAgent.isShuttingDown();
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final boolean startable = jaAgent.isStartable();
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final boolean starting = jaAgent.isStarting();
                    try {
                ...
                case 19: {
                    remoteCall.releaseInputStream();
                    final boolean stopable = jaAgent.isStopable();
                    try {
                ...
                case 20: {
                    remoteCall.releaseInputStream();
                    final String newChildName = jaAgent.makeNewChildName();
                    try {
                ...
                case 21: {
                    remoteCall.releaseInputStream();
                    final RemoteStub remoteStub = jaAgent.remoteStub();
                    try {
    ...
    public Operation[] getOperations() {
        return JAAgent_Skel.operations.clone();
    }
}

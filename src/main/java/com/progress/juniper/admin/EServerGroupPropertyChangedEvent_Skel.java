...
public final class EServerGroupPropertyChangedEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 592157051784600683L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EServerGroupPropertyChangedEvent eServerGroupPropertyChangedEvent = (EServerGroupPropertyChangedEvent)remote;
        Label_0932: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eServerGroupPropertyChangedEvent.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eServerGroupPropertyChangedEvent.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eServerGroupPropertyChangedEvent.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eServerGroupPropertyChangedEvent.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eServerGroupPropertyChangedEvent.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eServerGroupPropertyChangedEvent.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eServerGroupPropertyChangedEvent.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eServerGroupPropertyChangedEvent.getNotificationName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eServerGroupPropertyChangedEvent.getNotificationType();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final Object object = eServerGroupPropertyChangedEvent.getObject();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eServerGroupPropertyChangedEvent.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = eServerGroupPropertyChangedEvent.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eServerGroupPropertyChangedEvent.getSubCategory();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object guiID = eServerGroupPropertyChangedEvent.guiID();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eServerGroupPropertyChangedEvent.issuer();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final IJAService serverGroup = eServerGroupPropertyChangedEvent.serverGroup();
                    try {
                    ...
                    eServerGroupPropertyChangedEvent.setSource(source2);
                    try {
                ...
                case 18: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eServerGroupPropertyChangedEvent.timeIssued();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eServerGroupPropertyChangedEvent.issuerName();
                    try {
    ...
    public Operation[] getOperations() {
        return EServerGroupPropertyChangedEvent_Skel.operations.clone();
    }
}

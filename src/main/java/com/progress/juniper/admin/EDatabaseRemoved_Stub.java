...
public final class EDatabaseRemoved_Stub extends RemoteStub implements IERemoveEvent, IEDatabaseEvent, IEJAEvent, INotificationEvent, IEventObject, Remote
{
    ...
    public EDatabaseRemoved_Stub() {
    }
    
    public EDatabaseRemoved_Stub(final RemoteRef ref) {
        super(ref);
    }
    
    public Class classDef() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 0, -8837954516197242278L);
    ...
    public IJADatabase database() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 1, -8837954516197242278L);
            super.ref.invoke(call);
    ...
    public String description() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 2, -8837954516197242278L);
            super.ref.invoke(call);
            String s;
            try {
    ...
    public String eventTypeString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 3, -8837954516197242278L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public boolean expedite() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 4, -8837954516197242278L);
            super.ref.invoke(call);
            boolean boolean1;
            try {
    ...
    public short getCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 5, -8837954516197242278L);
            super.ref.invoke(call);
            short short1;
            try {
    ...
    public String getErrorString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 6, -8837954516197242278L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getEventData() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 7, -8837954516197242278L);
            super.ref.invoke(call);
            Object object;
            try {
    ...
    public String getNotificationName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 8, -8837954516197242278L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getNotificationType() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 9, -8837954516197242278L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getObject() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 10, -8837954516197242278L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public int getSeverityLevel() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 11, -8837954516197242278L);
            super.ref.invoke(call);
            int int1;
            try {
    ...
    public String getSource() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 12, -8837954516197242278L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getSubCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 13, -8837954516197242278L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object issuer() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 14, -8837954516197242278L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public String issuerName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 15, -8837954516197242278L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public void setSource(final String s) throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 16, -8837954516197242278L);
            try {
    ...
    public Date timeIssued() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EDatabaseRemoved_Stub.operations, 17, -8837954516197242278L);
            super.ref.invoke(call);
            Date date;
            try {

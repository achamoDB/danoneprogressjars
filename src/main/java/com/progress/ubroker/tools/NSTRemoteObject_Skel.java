...
public final class NSTRemoteObject_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final NSTRemoteObject nstRemoteObject = (NSTRemoteObject)remote;
        Label_0981: {
            while (true) {
                switch (n) {
                    case 0: {
                        remoteCall.releaseInputStream();
                        final String adminServerIPAddr = nstRemoteObject.getAdminServerIPAddr();
                        try {
                    ...
                    case 1: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrHost = nstRemoteObject.getAdminSrvrHost();
                        try {
                    ...
                    case 2: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrOSName = nstRemoteObject.getAdminSrvrOSName();
                        try {
                    ...
                    case 3: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrPort = nstRemoteObject.getAdminSrvrPort();
                        try {
                    ...
                    case 4: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrURL = nstRemoteObject.getAdminSrvrURL();
                        try {
                    ...
                    case 5: {
                        remoteCall.releaseInputStream();
                        final Enumeration children = nstRemoteObject.getChildren();
                        try {
                    ...
                    case 6: {
                        remoteCall.releaseInputStream();
                        final String displayName = nstRemoteObject.getDisplayName();
                        try {
                    ...
                    case 7: {
                        remoteCall.releaseInputStream();
                        final IEventBroker eventBroker = nstRemoteObject.getEventBroker();
                        try {
                        ...
                        final Hashtable logFiles = nstRemoteObject.getLogFiles(s);
                        try {
                    ...
                    case 9: {
                        remoteCall.releaseInputStream();
                        final String[] loginUserInfo = nstRemoteObject.getLoginUserInfo();
                        try {
                    ...
                    case 10: {
                        remoteCall.releaseInputStream();
                        final String mmcClientClass = nstRemoteObject.getMMCClientClass();
                        try {
                    ...
                    case 11: {
                        remoteCall.releaseInputStream();
                        final String propGroupPath = nstRemoteObject.getPropGroupPath();
                        try {
                    ...
                    case 12: {
                        remoteCall.releaseInputStream();
                        final String propertyFilename = nstRemoteObject.getPropertyFilename();
                        try {
                    ...
                    case 13: {
                        remoteCall.releaseInputStream();
                        final IPropertyManagerRemote rpm = nstRemoteObject.getRPM();
                        try {
                    ...
                    case 14: {
                        remoteCall.releaseInputStream();
                        final RemoteStub remStub = nstRemoteObject.getRemStub();
                        try {
                    ...
                    case 15: {
                        remoteCall.releaseInputStream();
                        final IYodaRMI remoteManageObject = nstRemoteObject.getRemoteManageObject();
                        try {
                        ...
                        final boolean rscLookedUp = nstRemoteObject.getRscLookedUp(s2);
                        try {
                    ...
                    case 18: {
                        remoteCall.releaseInputStream();
                        final String[] schemaPropFnList = nstRemoteObject.getSchemaPropFnList();
                        try {
                    ...
                    case 17: {
                        remoteCall.releaseInputStream();
                        final String schemaFilename = nstRemoteObject.getSchemaFilename();
                        try {
                    ...
                    case 19: {
                        remoteCall.releaseInputStream();
                        final String svcName = nstRemoteObject.getSvcName();
                        try {
                    ...
                    case 21: {
                        ...
                        Label_1405: {
                            ...
                            final IFileRef openFile = nstRemoteObject.openFile(s3, eventListener);
                            try {
                        ...
                        nstRemoteObject.regRscLookedUp(s4);
                        try {
    ...
    public Operation[] getOperations() {
        return NSTRemoteObject_Skel.operations.clone();
    }
}

...
public final class NSRemoteObject_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final NSRemoteObject nsRemoteObject = (NSRemoteObject)remote;
        Label_1114: {
            while (true) {
                switch (n) {
                    case 0: {
                        ...
                        final ToolRemoteCmdStatus doRemoteToolCmd = nsRemoteObject.doRemoteToolCmd(toolRemoteCmdDescriptor);
                        try {
                    ...
                    case 1: {
                        remoteCall.releaseInputStream();
                        final String adminServerIPAddr = nsRemoteObject.getAdminServerIPAddr();
                        try {
                    ...
                    case 2: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrHost = nsRemoteObject.getAdminSrvrHost();
                        try {
                    ...
                    case 3: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrOSName = nsRemoteObject.getAdminSrvrOSName();
                        try {
                    ...
                    case 4: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrPort = nsRemoteObject.getAdminSrvrPort();
                        try {
                    ...
                    case 5: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrURL = nsRemoteObject.getAdminSrvrURL();
                        try {
                    ...
                    case 6: {
                        remoteCall.releaseInputStream();
                        final Enumeration children = nsRemoteObject.getChildren();
                        try {
                    ...
                    case 7: {
                        remoteCall.releaseInputStream();
                        final String displayName = nsRemoteObject.getDisplayName();
                        try {
                    ...
                    case 8: {
                        remoteCall.releaseInputStream();
                        final IEventBroker eventBroker = nsRemoteObject.getEventBroker();
                        try {
                        ...
                        final Hashtable logFiles = nsRemoteObject.getLogFiles(s);
                        try {
                    ...
                    case 10: {
                        remoteCall.releaseInputStream();
                        final String[] loginUserInfo = nsRemoteObject.getLoginUserInfo();
                        try {
                    ...
                    case 11: {
                        remoteCall.releaseInputStream();
                        final String mmcClientClass = nsRemoteObject.getMMCClientClass();
                        try {
                    ...
                    case 12: {
                        remoteCall.releaseInputStream();
                        final String propGroupPath = nsRemoteObject.getPropGroupPath();
                        try {
                    ...
                    case 13: {
                        remoteCall.releaseInputStream();
                        final String propertyFilename = nsRemoteObject.getPropertyFilename();
                        try {
                    ...
                    case 14: {
                        remoteCall.releaseInputStream();
                        final IPropertyManagerRemote rpm = nsRemoteObject.getRPM();
                        try {
                    ...
                    case 15: {
                        remoteCall.releaseInputStream();
                        final RemoteStub remStub = nsRemoteObject.getRemStub();
                        try {
                    ...
                    case 16: {
                        remoteCall.releaseInputStream();
                        final IYodaRMI remoteManageObject = nsRemoteObject.getRemoteManageObject();
                        try {
                        ...
                        final boolean rscLookedUp = nsRemoteObject.getRscLookedUp(s2);
                        try {
                    ...
                    case 19: {
                        remoteCall.releaseInputStream();
                        final String[] schemaPropFnList = nsRemoteObject.getSchemaPropFnList();
                        try {
                    ...
                    case 20: {
                        remoteCall.releaseInputStream();
                        final String svcName = nsRemoteObject.getSvcName();
                        try {
                        ...
                        nsRemoteObject.regRscLookedUp(s3);
                        try {
                    ...
                    case 18: {
                        remoteCall.releaseInputStream();
                        final String schemaFilename = nsRemoteObject.getSchemaFilename();
                        try {
    ...
    public Operation[] getOperations() {
        return NSRemoteObject_Skel.operations.clone();
    }
}

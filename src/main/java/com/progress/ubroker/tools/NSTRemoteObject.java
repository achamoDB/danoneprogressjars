...
public class NSTRemoteObject extends AbstractGuiToolRemObj implements IChimeraHierarchy, IYodaSharedResources, IBTMsgCodes
{
    static final String NST_REMOTE_OBJ_NAME = "NameServer Tool Remote Object";
    RemoteStub m_stubObject;
    protected static NameContext nameTable;
    
    public NSTRemoteObject(final IYodaRMI yodaRMI, final String s, final String s2, final String s3, final String s4, final String s5, final String s6, final String s7) throws RemoteException {
    ...
    protected NameContext getNameContext() {
        return NSTRemoteObject.nameTable;
    }
    
    public static NSTRemoteObject findNSTRemoteObject(final String s) {
        try {
            return NSTRemoteObject.nameTable.get(AbstractGuiToolRemObj.adjustName(s));
        }
        catch (Throwable t) {
            return null;
        }
    ...
    public String getMMCClientClass() throws RemoteException {
        return "com.progress.vj.ubroker.NSTMMCClient";
    }
    ...
    public String getApplicationName() throws RemoteException {
        return "NameServer Tool Remote Object";
    }
    ...
    static {
        NSTRemoteObject.nameTable = new NameContext();
    }
}

...
public final class AbstractGuiPluginRemObj_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final AbstractGuiPluginRemObj abstractGuiPluginRemObj = (AbstractGuiPluginRemObj)remote;
        Label_1114: {
            while (true) {
                switch (n) {
                    case 0: {
                        ...
                        final ToolRemoteCmdStatus doRemoteToolCmd = abstractGuiPluginRemObj.doRemoteToolCmd(toolRemoteCmdDescriptor);
                        try {
                    ...
                    case 1: {
                        remoteCall.releaseInputStream();
                        final String adminServerIPAddr = abstractGuiPluginRemObj.getAdminServerIPAddr();
                        try {
                    ...
                    case 2: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrHost = abstractGuiPluginRemObj.getAdminSrvrHost();
                        try {
                    ...
                    case 3: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrOSName = abstractGuiPluginRemObj.getAdminSrvrOSName();
                        try {
                    ...
                    case 4: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrPort = abstractGuiPluginRemObj.getAdminSrvrPort();
                        try {
                    ...
                    case 5: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrURL = abstractGuiPluginRemObj.getAdminSrvrURL();
                        try {
                    ...
                    case 6: {
                        remoteCall.releaseInputStream();
                        final Enumeration children = abstractGuiPluginRemObj.getChildren();
                        try {
                    ...
                    case 7: {
                        remoteCall.releaseInputStream();
                        final String displayName = abstractGuiPluginRemObj.getDisplayName();
                        try {
                    ...
                    case 8: {
                        remoteCall.releaseInputStream();
                        final IEventBroker eventBroker = abstractGuiPluginRemObj.getEventBroker();
                        try {
                        ...
                        final Hashtable logFiles = abstractGuiPluginRemObj.getLogFiles(s);
                        try {
                    ...
                    case 10: {
                        remoteCall.releaseInputStream();
                        final String[] loginUserInfo = abstractGuiPluginRemObj.getLoginUserInfo();
                        try {
                    ...
                    case 11: {
                        remoteCall.releaseInputStream();
                        final String mmcClientClass = abstractGuiPluginRemObj.getMMCClientClass();
                        try {
                    ...
                    case 12: {
                        remoteCall.releaseInputStream();
                        final String propGroupPath = abstractGuiPluginRemObj.getPropGroupPath();
                        try {
                    ...
                    case 13: {
                        remoteCall.releaseInputStream();
                        final String propertyFilename = abstractGuiPluginRemObj.getPropertyFilename();
                        try {
                    ...
                    case 14: {
                        remoteCall.releaseInputStream();
                        final IPropertyManagerRemote rpm = abstractGuiPluginRemObj.getRPM();
                        try {
                    ...
                    case 15: {
                        remoteCall.releaseInputStream();
                        final RemoteStub remStub = abstractGuiPluginRemObj.getRemStub();
                        try {
                    ...
                    case 16: {
                        remoteCall.releaseInputStream();
                        final IYodaRMI remoteManageObject = abstractGuiPluginRemObj.getRemoteManageObject();
                        try {
                        ...
                        final boolean rscLookedUp = abstractGuiPluginRemObj.getRscLookedUp(s2);
                        try {
                    ...
                    case 19: {
                        remoteCall.releaseInputStream();
                        final String[] schemaPropFnList = abstractGuiPluginRemObj.getSchemaPropFnList();
                        try {
                    ...
                    case 20: {
                        remoteCall.releaseInputStream();
                        final String svcName = abstractGuiPluginRemObj.getSvcName();
                        try {
                        ...
                        abstractGuiPluginRemObj.regRscLookedUp(s3);
                        try {
                    ...
                    case 18: {
                        remoteCall.releaseInputStream();
                        final String schemaFilename = abstractGuiPluginRemObj.getSchemaFilename();
                        try {
    ...
    public Operation[] getOperations() {
        return AbstractGuiPluginRemObj_Skel.operations.clone();
    }
}

...
public final class AiaTRemoteObject_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final AiaTRemoteObject aiaTRemoteObject = (AiaTRemoteObject)remote;
        Label_0981: {
            while (true) {
                switch (n) {
                    case 0: {
                        remoteCall.releaseInputStream();
                        final String adminServerIPAddr = aiaTRemoteObject.getAdminServerIPAddr();
                        try {
                    ...
                    case 1: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrHost = aiaTRemoteObject.getAdminSrvrHost();
                        try {
                    ...
                    case 2: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrOSName = aiaTRemoteObject.getAdminSrvrOSName();
                        try {
                    ...
                    case 3: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrPort = aiaTRemoteObject.getAdminSrvrPort();
                        try {
                    ...
                    case 4: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrURL = aiaTRemoteObject.getAdminSrvrURL();
                        try {
                    ...
                    case 5: {
                        remoteCall.releaseInputStream();
                        final Enumeration children = aiaTRemoteObject.getChildren();
                        try {
                    ...
                    case 6: {
                        remoteCall.releaseInputStream();
                        final String displayName = aiaTRemoteObject.getDisplayName();
                        try {
                    ...
                    case 7: {
                        remoteCall.releaseInputStream();
                        final IEventBroker eventBroker = aiaTRemoteObject.getEventBroker();
                        try {
                        ...
                        final Hashtable logFiles = aiaTRemoteObject.getLogFiles(s);
                        try {
                    ...
                    case 9: {
                        remoteCall.releaseInputStream();
                        final String[] loginUserInfo = aiaTRemoteObject.getLoginUserInfo();
                        try {
                    ...
                    case 10: {
                        remoteCall.releaseInputStream();
                        final String mmcClientClass = aiaTRemoteObject.getMMCClientClass();
                        try {
                    ...
                    case 11: {
                        remoteCall.releaseInputStream();
                        final String propGroupPath = aiaTRemoteObject.getPropGroupPath();
                        try {
                    ...
                    case 12: {
                        remoteCall.releaseInputStream();
                        final String propertyFilename = aiaTRemoteObject.getPropertyFilename();
                        try {
                    ...
                    case 13: {
                        remoteCall.releaseInputStream();
                        final IPropertyManagerRemote rpm = aiaTRemoteObject.getRPM();
                        try {
                    ...
                    case 14: {
                        remoteCall.releaseInputStream();
                        final RemoteStub remStub = aiaTRemoteObject.getRemStub();
                        try {
                    ...
                    case 15: {
                        remoteCall.releaseInputStream();
                        final IYodaRMI remoteManageObject = aiaTRemoteObject.getRemoteManageObject();
                        try {
                        ...
                        final boolean rscLookedUp = aiaTRemoteObject.getRscLookedUp(s2);
                        try {
                    ...
                    case 18: {
                        remoteCall.releaseInputStream();
                        final String[] schemaPropFnList = aiaTRemoteObject.getSchemaPropFnList();
                        try {
                    ...
                    case 17: {
                        remoteCall.releaseInputStream();
                        final String schemaFilename = aiaTRemoteObject.getSchemaFilename();
                        try {
                    ...
                    case 19: {
                        remoteCall.releaseInputStream();
                        final String svcName = aiaTRemoteObject.getSvcName();
                        try {
                    ...
                    case 21: {
                        ...
                        Label_1405: {
                            ...
                            final IFileRef openFile = aiaTRemoteObject.openFile(s3, eventListener);
                            try {
                        ...
                        aiaTRemoteObject.regRscLookedUp(s4);
                        try {
    ...
    public Operation[] getOperations() {
        return AiaTRemoteObject_Skel.operations.clone();
    }
}

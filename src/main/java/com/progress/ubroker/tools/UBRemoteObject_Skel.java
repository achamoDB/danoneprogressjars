...
public final class UBRemoteObject_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final UBRemoteObject ubRemoteObject = (UBRemoteObject)remote;
        Label_1114: {
            while (true) {
                switch (n) {
                    case 0: {
                        ...
                        final ToolRemoteCmdStatus doRemoteToolCmd = ubRemoteObject.doRemoteToolCmd(toolRemoteCmdDescriptor);
                        try {
                    ...
                    case 1: {
                        remoteCall.releaseInputStream();
                        final String adminServerIPAddr = ubRemoteObject.getAdminServerIPAddr();
                        try {
                    ...
                    case 2: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrHost = ubRemoteObject.getAdminSrvrHost();
                        try {
                    ...
                    case 3: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrOSName = ubRemoteObject.getAdminSrvrOSName();
                        try {
                    ...
                    case 4: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrPort = ubRemoteObject.getAdminSrvrPort();
                        try {
                    ...
                    case 5: {
                        remoteCall.releaseInputStream();
                        final String adminSrvrURL = ubRemoteObject.getAdminSrvrURL();
                        try {
                    ...
                    case 6: {
                        remoteCall.releaseInputStream();
                        final Enumeration children = ubRemoteObject.getChildren();
                        try {
                    ...
                    case 7: {
                        remoteCall.releaseInputStream();
                        final String displayName = ubRemoteObject.getDisplayName();
                        try {
                    ...
                    case 8: {
                        remoteCall.releaseInputStream();
                        final IEventBroker eventBroker = ubRemoteObject.getEventBroker();
                        try {
                        ...
                        final Hashtable logFiles = ubRemoteObject.getLogFiles(s);
                        try {
                    ...
                    case 10: {
                        remoteCall.releaseInputStream();
                        final String[] loginUserInfo = ubRemoteObject.getLoginUserInfo();
                        try {
                    ...
                    case 11: {
                        remoteCall.releaseInputStream();
                        final String mmcClientClass = ubRemoteObject.getMMCClientClass();
                        try {
                    ...
                    case 12: {
                        remoteCall.releaseInputStream();
                        final String propGroupPath = ubRemoteObject.getPropGroupPath();
                        try {
                    ...
                    case 13: {
                        remoteCall.releaseInputStream();
                        final String propertyFilename = ubRemoteObject.getPropertyFilename();
                        try {
                    ...
                    case 14: {
                        remoteCall.releaseInputStream();
                        final IPropertyManagerRemote rpm = ubRemoteObject.getRPM();
                        try {
                    ...
                    case 15: {
                        remoteCall.releaseInputStream();
                        final RemoteStub remStub = ubRemoteObject.getRemStub();
                        try {
                    ...
                    case 16: {
                        remoteCall.releaseInputStream();
                        final IYodaRMI remoteManageObject = ubRemoteObject.getRemoteManageObject();
                        try {
                        ...
                        final boolean rscLookedUp = ubRemoteObject.getRscLookedUp(s2);
                        try {
                    ...
                    case 19: {
                        remoteCall.releaseInputStream();
                        final String[] schemaPropFnList = ubRemoteObject.getSchemaPropFnList();
                        try {
                    ...
                    case 20: {
                        remoteCall.releaseInputStream();
                        final String svcName = ubRemoteObject.getSvcName();
                        try {
                        ...
                        ubRemoteObject.regRscLookedUp(s3);
                        try {
                    ...
                    case 18: {
                        remoteCall.releaseInputStream();
                        final String schemaFilename = ubRemoteObject.getSchemaFilename();
                        try {
    ...
    public Operation[] getOperations() {
        return UBRemoteObject_Skel.operations.clone();
    }
}

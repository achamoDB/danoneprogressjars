...
public final class EStopServiceEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EStopServiceEvent eStopServiceEvent = (EStopServiceEvent)remote;
        Label_0984: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eStopServiceEvent.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eStopServiceEvent.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eStopServiceEvent.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eStopServiceEvent.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eStopServiceEvent.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eStopServiceEvent.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eStopServiceEvent.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String instanceName = eStopServiceEvent.getInstanceName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eStopServiceEvent.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eStopServiceEvent.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final IChimeraHierarchy pluginObj = eStopServiceEvent.getPluginObj();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String propGrpFullSpec = eStopServiceEvent.getPropGrpFullSpec();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eStopServiceEvent.getSeverityLevel();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String source = eStopServiceEvent.getSource();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eStopServiceEvent.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object guiID = eStopServiceEvent.guiID();
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eStopServiceEvent.issuerName();
                    try {
                    ...
                    eStopServiceEvent.setSource(source2);
                    try {
                ...
                case 19: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eStopServiceEvent.timeIssued();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eStopServiceEvent.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EStopServiceEvent_Skel.operations.clone();
    }
}

...
public final class EAddSrvrEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        ...
        final EAddSrvrEvent eAddSrvrEvent = (EAddSrvrEvent)remote;
        Label_0984: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eAddSrvrEvent.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eAddSrvrEvent.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eAddSrvrEvent.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eAddSrvrEvent.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eAddSrvrEvent.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final String errorString = eAddSrvrEvent.getErrorString();
                    try {
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eAddSrvrEvent.getEventData();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final String instanceName = eAddSrvrEvent.getInstanceName();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eAddSrvrEvent.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eAddSrvrEvent.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final IChimeraHierarchy pluginObj = eAddSrvrEvent.getPluginObj();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String propGrpFullSpec = eAddSrvrEvent.getPropGrpFullSpec();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eAddSrvrEvent.getSeverityLevel();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final String source = eAddSrvrEvent.getSource();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eAddSrvrEvent.getSubCategory();
                    try {
                ...
                case 15: {
                    remoteCall.releaseInputStream();
                    final Object guiID = eAddSrvrEvent.guiID();
                    try {
                ...
                case 17: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eAddSrvrEvent.issuerName();
                    try {
                    ...
                    eAddSrvrEvent.setSource(source2);
                    try {
                ...
                case 19: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eAddSrvrEvent.timeIssued();
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eAddSrvrEvent.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EAddSrvrEvent_Skel.operations.clone();
    }
}

...
public final class EStopServiceEvent_Stub extends RemoteStub implements IYodaPluginEventSuper, IEClientSpecificEvent, INotificationEvent, IEventObject, Remote
{
    ...
    public EStopServiceEvent_Stub() {
    }
    
    public EStopServiceEvent_Stub(final RemoteRef ref) {
        super(ref);
    }
    
    public Class classDef() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 0, -8860080668403469005L);
    ...
    public String description() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 1, -8860080668403469005L);
            super.ref.invoke(call);
            String s;
            try {
    ...
    public String eventTypeString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 2, -8860080668403469005L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public boolean expedite() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 3, -8860080668403469005L);
            super.ref.invoke(call);
            boolean boolean1;
            try {
    ...
    public short getCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 4, -8860080668403469005L);
            super.ref.invoke(call);
            short short1;
            try {
    ...
    public String getErrorString() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 5, -8860080668403469005L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object getEventData() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 6, -8860080668403469005L);
            super.ref.invoke(call);
            Object object;
            try {
    ...
    public String getInstanceName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 7, -8860080668403469005L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getNotificationName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 8, -8860080668403469005L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getNotificationType() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 9, -8860080668403469005L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public IChimeraHierarchy getPluginObj() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 10, -8860080668403469005L);
            super.ref.invoke(call);
    ...
    public String getPropGrpFullSpec() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 11, -8860080668403469005L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public int getSeverityLevel() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 12, -8860080668403469005L);
            super.ref.invoke(call);
            int int1;
            try {
    ...
    public String getSource() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 13, -8860080668403469005L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public String getSubCategory() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 14, -8860080668403469005L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public Object guiID() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 15, -8860080668403469005L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public Object issuer() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 16, -8860080668403469005L);
            super.ref.invoke(call);
            Object object;
            try {
                object = call.getInputStream().readObject();
    ...
    public String issuerName() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 17, -8860080668403469005L);
            super.ref.invoke(call);
            String s;
            try {
                s = (String)call.getInputStream().readObject();
    ...
    public void setSource(final String s) throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 18, -8860080668403469005L);
            try {
    ...
    public Date timeIssued() throws RemoteException {
        try {
            final RemoteCall call = super.ref.newCall(this, EStopServiceEvent_Stub.operations, 19, -8860080668403469005L);
            super.ref.invoke(call);
            Date date;
            try {

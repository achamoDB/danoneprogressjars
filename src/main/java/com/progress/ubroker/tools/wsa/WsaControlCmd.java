...
public class WsaControlCmd extends SvcControlCmd implements IBTMsgCodes
{
    public WsaControlCmd(final SvcStartArgsPkt svcStartArgsPkt, final String s, final String s2, final String s3) {

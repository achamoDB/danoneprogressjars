...
public final class EOpenEdgeManagementEvent_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, final int n, final long n2) throws Exception {
        if (n2 != 8274875999715894844L) {
            throw new SkeletonMismatchException("interface hash mismatch");
        }
        final EOpenEdgeManagementEvent eOpenEdgeManagementEvent = (EOpenEdgeManagementEvent)remote;
        Label_0828: {
            switch (n) {
                case 0: {
                    remoteCall.releaseInputStream();
                    final Class classDef = eOpenEdgeManagementEvent.classDef();
                    try {
                ...
                case 1: {
                    remoteCall.releaseInputStream();
                    final String description = eOpenEdgeManagementEvent.description();
                    try {
                ...
                case 2: {
                    remoteCall.releaseInputStream();
                    final String eventTypeString = eOpenEdgeManagementEvent.eventTypeString();
                    try {
                ...
                case 3: {
                    remoteCall.releaseInputStream();
                    final boolean expedite = eOpenEdgeManagementEvent.expedite();
                    try {
                ...
                case 4: {
                    remoteCall.releaseInputStream();
                    final short category = eOpenEdgeManagementEvent.getCategory();
                    try {
                ...
                case 5: {
                    remoteCall.releaseInputStream();
                    final COpenEdgeManagementContent content = eOpenEdgeManagementEvent.getContent();
                    try {
                        remoteCall.getResultStream(true).writeObject(content);
                        return;
                    }
                ...
                case 6: {
                    remoteCall.releaseInputStream();
                    final String errorString = eOpenEdgeManagementEvent.getErrorString();
                    try {
                ...
                case 7: {
                    remoteCall.releaseInputStream();
                    final Object eventData = eOpenEdgeManagementEvent.getEventData();
                    try {
                ...
                case 8: {
                    remoteCall.releaseInputStream();
                    final String notificationName = eOpenEdgeManagementEvent.getNotificationName();
                    try {
                ...
                case 9: {
                    remoteCall.releaseInputStream();
                    final String notificationType = eOpenEdgeManagementEvent.getNotificationType();
                    try {
                ...
                case 10: {
                    remoteCall.releaseInputStream();
                    final int severityLevel = eOpenEdgeManagementEvent.getSeverityLevel();
                    try {
                ...
                case 11: {
                    remoteCall.releaseInputStream();
                    final String source = eOpenEdgeManagementEvent.getSource();
                    try {
                ...
                case 12: {
                    remoteCall.releaseInputStream();
                    final String subCategory = eOpenEdgeManagementEvent.getSubCategory();
                    try {
                ...
                case 14: {
                    remoteCall.releaseInputStream();
                    final String issuerName = eOpenEdgeManagementEvent.issuerName();
                    try {
                    ...
                    eOpenEdgeManagementEvent.setSource(source2);
                    try {
                ...
                case 16: {
                    remoteCall.releaseInputStream();
                    final Date timeIssued = eOpenEdgeManagementEvent.timeIssued();
                    try {
                ...
                case 13: {
                    remoteCall.releaseInputStream();
                    final Object issuer = eOpenEdgeManagementEvent.issuer();
                    try {
    ...
    public Operation[] getOperations() {
        return EOpenEdgeManagementEvent_Skel.operations.clone();
    }
}

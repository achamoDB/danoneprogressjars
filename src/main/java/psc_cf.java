...
public class psc_cf extends psc_aj implements Cloneable, Serializable, psc_bj
{
    private String a;
    psc_n b;
    ...
    public psc_cf() {
        ...
        super.bt = false;
        this.a(psc_aj.al);
        super.a = "NetscapeCertRenewalURL";
    }
    
    public psc_cf(final String a, final boolean bt) {
        super.bu = 105;
        super.bt = bt;
        this.a(psc_aj.al);
        if (a != null) {
    ...
    public void d(final byte[] array, final int n) throws psc_g {
        ...
        try {
            ...
            throw new psc_g("Could not decode NetscapeCertRenewalURL extension.");
        }
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        final psc_cf psc_cf = new psc_cf();
        psc_cf.a = this.a;
        if (this.b != null) {
            psc_cf.e();
        }

...
public class psc_go extends psc_fz implements Cloneable, Serializable
{
    private String a;
    psc_n b;
    ...
    public psc_go(final String s) throws psc_f0 {
        this();
        this.b(s);
    }
    ...
    protected void a(final byte[] array, final int n) throws psc_f0 {
        ...
        try {
            ...
            throw new psc_f0("Could not BER decode CountryOfResidence.");
        }
    }
    ...
    public void b(final String a) throws psc_f0 {
        if (a != null) {
            if (a.length() != 2) {
                throw new psc_f0("Country of Residence should be 2 characters long.");
            }
            this.e();
            this.a = a;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        final psc_go psc_go = new psc_go();
        if (this.a != null) {
            psc_go.a = this.a;
        }
        super.a(psc_go);
    ...
    public boolean equals(final Object o) {
        return o != null && o instanceof psc_go && this.a.equalsIgnoreCase(((psc_go)o).a);
    }

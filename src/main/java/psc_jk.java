...
public final class psc_jk extends psc_jj implements Cloneable, Serializable
{
    private int a;
    private byte[] b;
    private int c;
    ...
    public void a(final psc_dg psc_dg, final psc_di psc_di, final psc_dm psc_dm, final byte[] array, final int n, final int n2) throws psc_ao {
        throw new psc_ao("BER of PKCS 12 PBE requires PKCS12V1PBE.");
    }
    
    public byte[] a(final String s, final String s2) throws psc_ao {
        throw new psc_ao("DER of PKCS 12 PBE requires PKCS12V1PBE.");
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        final psc_jk psc_jk = new psc_jk();
        psc_jk.c = this.c;
        psc_jk.a = this.a;
        if (this.b != null) {
            psc_jk.b = this.b.clone();
        }
        return psc_jk;
    }

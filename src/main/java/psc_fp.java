...
public class psc_fp implements Cloneable, Serializable
{
    private String[][] a;
    int b;
    ...
    public psc_fp(final byte[] array, final int n, final int n2) throws psc_v {
        this.a = new String[4][2];
        this.b = 0;
        this.d = null;
        if (array == null) {
        ...
        try {
            ...
            final int j = psc_w.j();
            if (j > 4) {
                throw new psc_v("Too many BuiltInDomainDefinedAttributes: MAX number is 4.");
            }
            for (int i = 0; i < j; ++i) {
                final psc_i a = psc_w.a(i);
                final psc_h psc_h = new psc_h(0);
                final psc_j psc_j = new psc_j();
                final psc_aa psc_aa = new psc_aa(0, 1, 8);
                final psc_aa psc_aa2 = new psc_aa(0, 1, 128);
                psc_l.a(a.b, a.c, new psc_i[] { psc_h, psc_aa, psc_aa2, psc_j });
                if (psc_aa.b != null && psc_aa.d != 0 && psc_aa2.b != null && psc_aa2.d != 0) {
                    this.a[this.b][0] = psc_aa.e();
                    this.a[this.b][1] = psc_aa2.e();
                    ++this.b;
                }
            }
        }
        catch (Exception ex) {
            throw new psc_v("Cannot decode the BER of BuiltInDomainDefinedAttributes.");
        }
    }
    ...
    public int a(final byte[] array, final int n, final int n2) throws psc_v {
        ...
        try {
            if ((this.d == null || n2 != psc_fp.c) && this.c(n2) == 0) {
                throw new psc_v("Unable to encode BuiltInDomainDefinedAttributes");
            }
    ...
    private int a() throws psc_v {
        if (this.d != null && psc_fp.c == psc_fp.c) {
            return 0;
        }
        try {
            final Vector vector = new Vector<psc_w>();
            final psc_w obj = new psc_w(psc_fp.c, true, 0, 12288, new psc_k(12288));
            ...
            for (int i = 0; i < this.b; ++i) {
                try {
                    ...
                    throw new psc_v("Can't encode BuiltInDomainDefinedAttributes");
                }
            }
    ...
    private psc_k a(final int n) throws psc_v {
        ...
        psc_k psc_k;
        try {
            final psc_n psc_n = new psc_n(new psc_i[] { psc_h, new psc_aa(0, true, 0, this.a[n][0], 1, 8), new psc_aa(0, true, 0, this.a[n][1], 1, 128), psc_j });
            final byte[] array = new byte[psc_n.a()];
            psc_k = new psc_k(12288, true, 0, array, 0, psc_n.a(array, 0));
        }
        catch (psc_m psc_m) {
            throw new psc_v(" Can't encode BuiltInDomainDefinedAttribute");
        }
        return psc_k;
    }
    
    public boolean equals(final Object o) {
        if (o == null || !(o instanceof psc_fp)) {
            return false;
        }
        final psc_fp psc_fp = (psc_fp)o;
        if (this.b != psc_fp.b) {
            return false;
        }
        for (int i = 0; i < this.b; ++i) {
            if (!this.a[i][0].equals(psc_fp.a[i][0])) {
                return false;
            }
            if (!this.a[i][1].equals(psc_fp.a[i][1])) {
                return false;
            }
        }
        return true;
    ...
    public Object clone() throws CloneNotSupportedException {
        final psc_fp psc_fp = new psc_fp();
        psc_fp.b = this.b;
        for (int i = 0; i < this.b; ++i) {
            psc_fp.a[i][0] = new String(this.a[i][0]);
            psc_fp.a[i][1] = new String(this.a[i][1]);
        }
        psc_fp.c = psc_fp.c;
        try {
            if (this.d != null) {
